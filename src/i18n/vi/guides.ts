...
export const guides = {
  ...
  'guides.agentkit.building_blocks.title': 'Kit, Skill, Agent và Hook',
  'guides.agentkit.building_blocks.description': 'Chọn đúng khối xây dựng cho công việc của bạn',
  'guides.agentkit.runtime_support.title': 'Hỗ Trợ Runtime',
  'guides.agentkit.runtime_support.description': 'Cách adapter đưa nội dung Kit vào coding agent',
  'guides.agentkit.desktop_app.title': 'Ứng Dụng AgentKit Desktop',
  'guides.agentkit.desktop_app.description': 'Trung tâm điều khiển trực quan cho trạng thái AgentKit local',
  'guides.agentkit.getting_started.title': 'Cài Đặt và Onboarding',
  'guides.agentkit.getting_started.description': 'Cài ak CLI và chạy Kit đầu tiên',
  'guides.agentkit.configuration.title': 'Cấu Hình (config.yaml)',
  'guides.agentkit.configuration.description': 'config.yaml AgentKit: scope user/project, setting, mặc định và options',
  'guides.agentkit.cli_commands.title': 'Tra Cứu AK CLI',
  'guides.agentkit.cli_commands.description': 'Cheatsheet lệnh ak — flags, subcommands, và ví dụ',
  'guides.agentkit.skills.title': 'Bảng Skills',
  ...
  'guides.agentkit.statusline.description': 'Statusline Claude Code: mặc định, options statuslineLayout, và cách custom',
