...
export const guides = {
  ...
  'guides.agentkit.skills.title': 'Cheatsheet skill AgentKit',
  'guides.agentkit.skills.description': 'Skill Engineer Kit và Marketing Kit — nhánh lệnh, tham số, flag. Gọi /ak: hoặc $ak:',
  ...
  'guides.agentkit.clean_reinstall.description': 'Gỡ kit có ownership, tùy chọn reset state, cài lại AgentKit stable',
