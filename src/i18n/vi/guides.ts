...
export const guides = {
  ...
  'guides.home.pathway_feature.title': 'Multi-Provider & Công Cụ',
  'guides.home.pathway_feature.desc': 'Kết nối provider thay thế, điều khiển từ xa, và cấu hình IDE',
  ...
  'guides.home.pathway_feature.link_migrate': 'Migrate sang Tool Khác',
  // Pathway: Optimization
  'guides.home.pathway_optimization.title': 'Tối Ưu',
  'guides.home.pathway_optimization.desc': 'Trau chuốt UI/UX và tiết kiệm token để làm việc hiệu quả hơn',
  'guides.home.pathway_optimization.link_uiux': 'Thiết Kế UI/UX',
  'guides.home.pathway_optimization.link_token_tips': 'Tiết Kiệm Token',
  // Pathway: Troubleshooting & Recovery
  'guides.home.pathway_troubleshooting.title': 'Xử Lý Sự Cố & Khôi Phục',
  'guides.home.pathway_troubleshooting.desc': 'Khôi phục session và debug lỗi từ log',
  'guides.home.pathway_troubleshooting.link_session': 'Khôi Phục Session',
  'guides.home.pathway_troubleshooting.link_fix_logs': 'Sửa Lỗi Từ Log',
