...
export const workflows = {
  ...
  'workflows.guide.banner.title': 'Mới với AgentKit?',
  ...
  'workflows.tip.scout.desc': 'Sử dụng `/ak:scout` để tìm nhanh các file liên quan trong codebase của bạn',
  'workflows.tip.debug.title': 'Debug trước khi sửa',
  'workflows.tip.debug.desc': 'Sử dụng `/ak:debug` trước để tìm nguyên nhân gốc rễ, sau đó dùng `/ak:fix` khi đã sẵn sàng',

  'workflows.tip.plan.title': 'Luôn bắt đầu với /ak:plan',
  'workflows.tip.plan.desc': 'Tạo một kế hoạch có cấu trúc trước, sau đó sử dụng `/ak:cook` để triển khai',
  ...
  'workflows.more.link': 'tài liệu đầy đủ từ trang web chính thức của AgentKit',
  'workflows.guide.recipes_title': 'Quy Trình Mẫu',
  'workflows.v24.banner_intro': 'sử dụng command-based workflows.',
  'workflows.v24.banner_note': 'Sau /ak:plan, dùng /ak:cook để triển khai từng bước.',
  'workflows.tip.cook.title': 'Dùng /ak:cook để triển khai',
  'workflows.tip.cook.desc': 'Sau khi lên kế hoạch với `/ak:plan`, chạy `/clear` rồi `/ak:cook` để triển khai plan của bạn',
  'workflows.v25.cook_flags_title': 'Flags của /ak:cook',
