...
export const common = {
  ...
  'promotions.alibaba.tagline': 'Lite $10/tháng · Pro $50/tháng — Gia hạn lần đầu giảm 50%!',
  'promotions.alibaba.stock_info': '⚠️ Số lượng có hạn! Restock hàng ngày lúc 9:30 sáng (GMT+8)',
  ...
  'promotions.alibaba.value': '💰 Gia hạn lần đầu giảm 50%: Lite $10→$5, Pro $50→$25 — cực kỳ hời cho AI coding!',
