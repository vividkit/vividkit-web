export default {
  ...
  'ide_config.guide.google_warning_desc': 'Google đang tích cực ban các tài khoản sử dụng Antigravity/Gemini OAuth với công cụ bên thứ ba (OpenCode, CLIProxy, CCS, ProxyPal, AntigravityManager, v.v.). Việc xác thực tài khoản Google với các công cụ này có thể vi phạm ToS và dẫn đến mất quyền truy cập vào tất cả dịch vụ Google. Sử dụng rủi ro tự chịu.',
