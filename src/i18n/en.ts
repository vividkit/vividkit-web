export default {
  ...
  'happy_ccs.guide.google_warning_desc': 'Google is actively banning accounts that authenticate Antigravity/Gemini OAuth with third-party tools (CLIProxy-based tools like CCS, ProxyPal, AntigravityManager, etc.). This may violate Google\'s ToS and result in permanent loss of access to all Google services. Use GLM or Kimi as safer alternatives.',
  ...
  'ccs.guide.google_ban_warning_desc': 'Google is actively banning accounts that use Antigravity/Gemini OAuth with third-party tools (OpenCode, CLIProxy-based tools like CCS/ProxyPal, AntigravityManager, etc.). Using these tools may violate Google\'s ToS and result in permanent loss of access to all Google services including Gmail, Drive, and YouTube. Proceed at your own risk.',
  ...
  'session_recovery.guide.google_ban_warning_desc': 'Google is actively banning accounts using Antigravity/Gemini OAuth with third-party tools (OpenCode, CLIProxy-based tools like CCS, AntigravityManager, etc.). Using these tools may violate Google\'s ToS and result in permanent loss of access to Google services. Use GLM or Kimi instead.',
