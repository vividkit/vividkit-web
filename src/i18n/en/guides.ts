...
export const guides = {
  ...
  'guides.sections.methods': 'Methods & Workflows',
  ...
  'guides.sections.badge.recommended': 'Recommended',
  'guides.sections.badge.existing': 'Existing setups',
  'guides.nav.choose_setup': 'Choose Your Setup',
  ...
  'guides.cli.purchase_notice.title': 'ClaudeKit CLI note',
  'guides.cli.purchase_notice.desc': 'Note: ClaudeKit CLI is a free tool that helps install kits. The Engineer Kit and Marketing Kit are paid products that you need to purchase separately. New setups should start with AgentKit.',
  'guides.cli.purchase_notice.cta': 'Get ClaudeKit (30% OFF)',
  // CK setup notice (non-blocking)
  'guides.ck_notice.body': 'This guide is for an existing ClaudeKit setup. ClaudeKit remains supported. Starting a new setup?',
  'guides.ck_notice.link': 'See the AgentKit guide',
  // AgentKit nav titles
  'guides.agentkit.title': 'What Is AgentKit?',
  'guides.agentkit.description': 'Beginner-friendly introduction to AgentKit',
  'guides.agentkit.how_it_works.title': 'How AgentKit Works',
  'guides.agentkit.how_it_works.description': 'From verified Kit releases to reviewed project artifacts',
  'guides.agentkit.building_blocks.title': 'Kits, Skills, Agents, and Hooks',
  'guides.agentkit.building_blocks.description': 'Choose the right building block for your task',
  'guides.agentkit.runtime_support.title': 'Runtime Support',
  'guides.agentkit.runtime_support.description': 'How adapters deliver Kit content to coding agents',
  'guides.agentkit.desktop_app.title': 'AgentKit Desktop App',
  'guides.agentkit.desktop_app.description': 'Visual control center for local AgentKit state',
  'guides.agentkit.getting_started.title': 'Installation and Onboarding',
  'guides.agentkit.getting_started.description': 'Install the ak CLI and get your first Kit running',
  'guides.agentkit.configuration.title': 'Configuration (config.yaml)',
  'guides.agentkit.configuration.description': 'AgentKit config.yaml: user vs project scope, settings, defaults, and options',
  'guides.agentkit.cli_commands.title': 'AK CLI Quick Reference',
  'guides.agentkit.cli_commands.description': 'AgentKit ak CLI commands cheatsheet — flags, subcommands, and examples',
  'guides.agentkit.skills.title': 'Skills Cheatsheet',
  'guides.agentkit.skills.description': 'Engineer and Marketing Kit skills with subcommands, args, and flags — /ak: and $ak:',
  'guides.agentkit.statusline.title': 'Statusline',
  'guides.agentkit.statusline.description': 'Claude Code statusline defaults, statuslineLayout options, and how to customize',
  ...
  'guides.agentkit.troubleshooting.title': 'AgentKit Troubleshooting',
  'guides.agentkit.troubleshooting.description': 'Quick checks when the AgentKit CLI, Desktop App, or runtime adapters misbehave',
  ...
  'guides.home.subtitle': 'Choose AgentKit for new setups, keep ClaudeKit for existing ones, or migrate when you are ready.',
  'guides.home.tip': 'Tip: On desktop, use the left menu to jump to other guides quickly',
  'guides.home.entry_ak.title': 'Start with AgentKit',
  'guides.home.entry_ak.desc': 'Recommended for new setups. Learn the product model, then install the ak CLI.',
  'guides.home.entry_ak.badge': 'Recommended',
  'guides.home.entry_ak.link_what': 'What Is AgentKit?',
  'guides.home.entry_ak.link_start': 'Get Started',
  'guides.home.entry_ck.title': 'Continue with ClaudeKit',
  'guides.home.entry_ck.desc': 'Existing ClaudeKit setups remain supported. Keep using the guides and commands you already know.',
  'guides.home.entry_ck.badge': 'Existing setups',
  'guides.home.entry_ck.link_what': 'What Is ClaudeKit?',
  'guides.home.entry_ck.link_cli': 'CLI & Installation',
  'guides.home.entry_migrate.title': 'Migrate from ClaudeKit to AgentKit',
  'guides.home.entry_migrate.desc': 'Back up configuration, review the differences, and migrate when ready. Migration is optional, not forced.',
  'guides.home.entry_migrate.link': 'Open migration guide',
  'guides.home.more_title': 'Tools & methods',
  'guides.home.more_desc': 'Runtime tools and practical workflows. Some pages still assume ClaudeKit command syntax.',
