...
export const guides = {
  ...
  'guides.home.inside_claudekit.topic_1.title': 'Unlocking the full power of /ck:plan with the new --tdd and --deep modes',
  'guides.home.inside_claudekit.topic_1.desc': 'A closer look at when to use each mode, how they change plan quality, and where they fit in real implementation work.',
