...
export const common = {
  ...
  'promotions.alibaba.tagline': 'Lite $10/mo · Pro $50/mo — First renewal 50% off!',
  'promotions.alibaba.stock_info': '⚠️ Limited stock! Restocks daily at 9:30 AM (GMT+8)',
  ...
  'promotions.alibaba.value': '💰 First renewal 50% off: Lite $10→$5, Pro $50→$25 — great value for AI coding!',
