...
export const GET: APIRoute = () => {
  ...
  const pages = [
    ...
    { path: '/guides/cursor', changefreq: 'monthly', priority: '0.8' },
    { path: '/guides/cursor/subagents', changefreq: 'monthly', priority: '0.7' },
    { path: '/guides/cursor/hooks', changefreq: 'monthly', priority: '0.7' },
    { path: '/guides/cursor/commands', changefreq: 'monthly', priority: '0.7' },
