    ...
    },
    {
      ...
      commands: [
        ...
        },
        {
          ...
          complexity: "⚡⚡",
          label: t("commands.label.medium"),
          desc: t("commands.stable.advise.desc"),
          detail: t("commands.stable.advise.detail"),
          isSkill: true,
          isBeta: true,
          args: ["[prompt-or-url]"],
          flags: ["--html", "--md", "--wiki", "--github", "--agent"],
        },
        {
          command: "/ck:research",
          complexity: "⚡⚡",
        ...
        },
        {
          ...
          complexity: "⚡⚡⚡",
          label: t("commands.label.medium"),
          desc: t("commands.stable.issue_to_plan.desc"),
          detail: t("commands.stable.issue_to_plan.detail"),
          isSkill: true,
          isBeta: true,
          args: ["<github-issue-url | issue-number>"],
          flags: ["--repo owner/name", "--plan-ready-label", "--decision-label"],
        },
        {
          command: "/ck:goal-warmup",
          complexity: "⚡⚡",
          label: t("commands.label.medium"),
          desc: t("commands.stable.goal_warmup.desc"),
          detail: t("commands.stable.goal_warmup.detail"),
          isSkill: true,
          isBeta: true,
          args: ['"<goal>"'],
          flags: ["--fast"],
        },
        {
          ...
          complexity: "⚡⚡",
          label: t("commands.label.medium"),
          desc: t("commands.stable.fable_thinking.desc"),
          detail: t("commands.stable.fable_thinking.detail"),
          isSkill: true,
          isBeta: true,
        ...
        },
        {
          ...
          complexity: "⚡",
          label: t("commands.label.easy"),
          desc: t("commands.stable.research_prompt.desc"),
          detail: t("commands.stable.research_prompt.detail"),
          isSkill: true,
          isBeta: true,
          args: ["<research topic | decision>"],
        },
      ],
    },
    {
    ...
    },
    {
      ...
      commands: [
        ...
        },
        {
          ...
          complexity: "⚡",
          label: t("commands.label.easy"),
          desc: t("commands.stable.document_skills.desc"),
          detail: t("commands.stable.document_skills.detail"),
          isSkill: true,
          isBeta: true,
          args: ["[document task]"],
        },
    ...
    },
    {
      ...
      commands: [
        ...
        },
        {
          ...
          complexity: "⚡⚡",
          label: t("commands.label.medium"),
          desc: t("commands.stable.interview_docs.desc"),
          detail: t("commands.stable.interview_docs.detail"),
          isSkill: true,
          isBeta: true,
    ...
    },
    {
      ...
      commands: [
        ...
        },
        {
          ...
          complexity: "⚡",
          label: t("commands.label.easy"),
          desc: t("commands.stable.handoff.desc"),
          detail: t("commands.stable.handoff.detail"),
          isSkill: true,
          isBeta: true,
    ...
    },
    {
      ...
      commands: [
        ...
        },
        {
          ...
          complexity: "⚡⚡",
          label: t("commands.label.medium"),
          desc: t("commands.stable.codex_goal.desc"),
          detail: t("commands.stable.codex_goal.detail"),
          isSkill: true,
          isBeta: true,
          args: ["<objective | goal draft>"],
        },
        {
          command: "/ck:folder-context",
          complexity: "⚡",
          label: t("commands.label.easy"),
          desc: t("commands.stable.folder_context.desc"),
          detail: t("commands.stable.folder_context.detail"),
          isSkill: true,
          isBeta: true,
          args: ["<target-folder>"],
        },
