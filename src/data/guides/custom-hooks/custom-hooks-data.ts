  ...
  },
  {
    ...
    hooks: [
      ...
      },
      {
        ...
        descEn: 'Track file modifications and remind to run code-simplifier after significant edits.',
        descVi: 'Theo dõi file thay đổi và nhắc chạy code-simplifier sau các chỉnh sửa lớn.',
      },
      {
