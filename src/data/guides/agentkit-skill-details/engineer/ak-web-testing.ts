...
const data: SkillInfographic = {
  ...
  promptExamples: [
    { labelEn: 'E2E target', labelVi: 'Mục tiêu E2E', command: '/ak:web-testing e2e checkout flow', whenEn: 'A browser user journey needs automation or debugging.', whenVi: 'Một hành trình người dùng trên trình duyệt cần tự động hóa hoặc debug.', expectedEn: 'Chooses Playwright patterns, fixtures, selectors, and CI sharding guidance.', expectedVi: 'Chọn pattern Playwright, fixture, selector và hướng dẫn sharding CI.', recommended: true },
    { labelEn: 'Unit and integration', labelVi: 'Unit và integration', command: '/ak:web-testing unit integration auth module', whenEn: 'Fast feedback and service/module behavior are the main concern.', whenVi: 'Mục tiêu chính là phản hồi nhanh và hành vi module/service.', expectedEn: 'Uses Vitest AAA patterns, test data management, and database isolation where needed.', expectedVi: 'Dùng pattern Vitest AAA, quản lý test data và cách ly database khi cần.' },
    { labelEn: 'Load test', labelVi: 'Test tải', command: '/ak:web-testing load API endpoints', whenEn: 'Throughput, latency, or saturation needs measurement.', whenVi: 'Cần đo throughput, latency hoặc điểm bão hòa.', expectedEn: 'Applies k6 load-testing references and reports threshold-oriented results.', expectedVi: 'Áp reference k6 và báo kết quả theo ngưỡng.' },
    { labelEn: 'Accessibility and performance', labelVi: 'Accessibility và hiệu năng', command: '/ak:web-testing accessibility performance homepage', whenEn: 'Release quality depends on WCAG and Core Web Vitals checks.', whenVi: 'Chất lượng release phụ thuộc vào kiểm WCAG và Core Web Vitals.', expectedEn: 'Uses axe-core and Lighthouse/Core Web Vitals guidance for the target page.', expectedVi: 'Dùng hướng dẫn axe-core và Lighthouse/Core Web Vitals cho trang mục tiêu.' },
  ],
};
