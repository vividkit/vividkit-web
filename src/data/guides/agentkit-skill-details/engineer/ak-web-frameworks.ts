  ...
  arguments: [
    {
      ...
      exampleCommand: '/ak:web-frameworks nextjs "Add an App Router product page in the existing pinned Next.js version"',
          exampleCommandVi: '/ak:web-frameworks nextjs "Thêm trang sản phẩm App Router trong phiên bản Next.js đã ghim hiện có"',
    },
    {
      token: '[feature]',
      ...
      exampleCommand: '/ak:web-frameworks Turborepo monorepo for web, admin, docs, and shared UI packages',
          exampleCommandVi: '/ak:web-frameworks Turborepo monorepo cho web, admin, docs, và các package UI dùng chung',
    },
  ],
};
