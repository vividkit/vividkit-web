...
const data: SkillInfographic = {
  ...
  promptExamples: [
    ...
    { labelEn: "Workflow export", labelVi: "Xuất workflow", command: "/ak:excalidraw visualize the onboarding workflow and export PNG/SVG", whenEn: "A workflow needs an editable diagram plus requested review/export formats.", whenVi: "Workflow cần sơ đồ có thể chỉnh sửa cùng các định dạng review/export được yêu cầu.", expectedEn: "Chooses a timeline, cycle, or phase-break structure instead of uniform cards, creates the Excalidraw source or live canvas, visually checks clipping, overlaps, spacing, and arrow routing, then returns the requested PNG/SVG exports.", expectedVi: "Chọn cấu trúc timeline, cycle hoặc phase-break thay vì card đồng dạng, tạo source Excalidraw hoặc canvas trực tiếp, kiểm tra trực quan clipping, overlap, spacing và hướng arrow, rồi trả PNG/SVG đã yêu cầu." },
  ],
};
