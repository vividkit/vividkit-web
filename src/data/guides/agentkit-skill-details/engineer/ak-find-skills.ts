  ...
  arguments: [
    {
      ...
      exampleCommand: "/ak:find-skills \"Audit a Next.js checkout for accessibility and keyboard navigation\"",
          exampleCommandVi: '/ak:find-skills "Audit a Next.js checkout for accessibility and keyboard navigation"',
    },
  ],
};
