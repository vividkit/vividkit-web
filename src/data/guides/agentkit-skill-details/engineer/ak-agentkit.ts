    ...
    arguments: [
      {
        ...
        exampleCommand:
          ...
          exampleCommandVi: '/ak:agentkit "Add subscription billing và một trang settings; yêu cầu tests và stop trước deployment"',
      },
    ],
  },
  promptExamples: [
    {
      ...
      commandVi: '/ak:agentkit "Thêm thanh toán nhóm với Stripe và trang cài đặt; yêu cầu kiểm thử và dừng trước khi triển khai"',
    ...
    },
    {
      ...
      commandVi: '/ak:agentkit "Workflow AgentKit nào nên xử lý việc di chuyển API công khai?"',
    ...
    },
    {
      ...
      commandVi: '/ak:agentkit "Lập kế hoạch và thực hiện làm mới trang ra mắt docs + frontend"',
    ...
    },
    {
      ...
      commandVi: '/ak:agentkit "Sửa CI đang lỗi trên nhánh này"',
