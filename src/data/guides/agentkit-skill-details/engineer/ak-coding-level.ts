  ...
  invocation: {
    ...
    arguments: [
      { token: '[0-5]', titleEn: 'Level', titleVi: 'Level', descEn: 'One integer from 0 through 5. The skill stores it in .claude/.ck.json and does not change repo rules or safety.', descVi: 'Một số nguyên từ 0 đến 5. Skill lưu vào .claude/.ck.json và không đổi rule repo hay safety.', required: true, exampleCommand: '/ak:coding-level 2',
          exampleCommandVi: '/ak:coding-level 2' },
    ],
  },
  promptExamples: [
    { labelEn: 'Junior teaching mode', labelVi: 'Chế độ dạy junior', command: '/ak:coding-level 1',
    ...
    { labelEn: 'Mid-level system thinking', labelVi: 'System thinking mức mid', command: '/ak:coding-level 2',
    ...
    { labelEn: 'Tech-lead framing', labelVi: 'Góc nhìn tech lead', command: '/ak:coding-level 4',
    ...
    { labelEn: 'Maximum efficiency', labelVi: 'Hiệu quả tối đa', command: '/ak:coding-level 5',
