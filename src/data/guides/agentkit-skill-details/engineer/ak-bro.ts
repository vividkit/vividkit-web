...
const data: SkillInfographic = {
  ...
  promptExamples: [
    { labelEn: 'Default restatement', labelVi: 'Viết lại mặc định', command: '/ak:bro', whenEn: 'Use immediately after an assistant reply that felt too formal, long, or jargon-heavy.', whenVi: 'Dùng ngay sau câu trả lời AI quá trang trọng, dài, hoặc nhiều thuật ngữ.', expectedEn: 'Returns only a simpler restatement of that previous assistant message.', expectedVi: 'Chỉ trả về bản viết lại dễ hiểu hơn của câu trả lời AI trước đó.', recommended: true },
    { labelEn: 'Human wording', labelVi: 'Nói như người thường', command: '/ak:bro', whenEn: 'Use when the user asks “say it plainly” or “explain it like a human.”', whenVi: 'Dùng khi người dùng muốn “nói dễ hiểu” hoặc “giải thích như người thường”.', expectedEn: 'Keeps the substance while cutting filler and replacing jargon.', expectedVi: 'Giữ nội dung chính, cắt câu thừa và thay thuật ngữ bằng lời thường.' },
  ],
};
