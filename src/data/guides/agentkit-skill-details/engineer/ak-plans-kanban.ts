...
const data: SkillInfographic = {
  ...
  invocation: {
    ...
    options: [
      { token: '--open', titleEn: 'Open dashboard', titleVi: 'Mở dashboard', descEn: 'Default or explicit. Finds or starts the dashboard, probes plans support, opens /plans, and prints JSON.', descVi: 'Mặc định hoặc chỉ định rõ. Tìm hoặc khởi động dashboard, probe hỗ trợ plans, mở /plans và in JSON.', exampleCommand: '/ak:plans-kanban --open',
          exampleCommandVi: '/ak:plans-kanban --open' },
      { token: '--no-open', titleEn: 'Report URL only', titleVi: 'Chỉ báo URL', descEn: 'Perform discovery and capability checks, then report the /plans URL without opening a browser.', descVi: 'Thực hiện discovery và kiểm tra capability, rồi báo URL /plans mà không mở browser.', exampleCommand: '/ak:plans-kanban --no-open',
          exampleCommandVi: '/ak:plans-kanban --no-open' },
      { token: '--stop', titleEn: 'Stop dashboard', titleVi: 'Dừng dashboard', descEn: 'Delegate to ak config stop and return that command result instead of opening /plans.', descVi: 'Ủy quyền cho ak config stop và trả kết quả lệnh đó thay vì mở /plans.', exampleCommand: '/ak:plans-kanban --stop',
          exampleCommandVi: '/ak:plans-kanban --stop' },
    ],
  },
  promptExamples: [
    { labelEn: 'Open dashboard', labelVi: 'Mở dashboard', command: '/ak:plans-kanban',
      commandVi: '/ak:plans-kanban', whenEn: 'Use when you want to open the visual plans dashboard.', whenVi: 'Dùng khi muốn mở dashboard kế hoạch trực quan.', expectedEn: 'The launcher reuses a running config dashboard or starts one on port 8766, probes plans support, then opens /plans in the browser.', expectedVi: 'Launcher dùng lại dashboard config đang chạy hoặc khởi động cổng 8766, probe hỗ trợ plans rồi mở /plans trong browser.', recommended: true },
    { labelEn: 'Inspect plan progress', labelVi: 'Kiểm tra tiến độ plan', command: '/ak:plans-kanban',
      commandVi: '/ak:plans-kanban', whenEn: 'Use when you need kanban, grid, timeline, or progress views for plans.', whenVi: 'Dùng khi cần view kanban, grid, timeline hoặc tiến độ cho các plan.', expectedEn: 'The integrated dashboard shows active and completed plan visibility with links into plan.md and phase-*.md files.', expectedVi: 'Dashboard tích hợp hiển thị plan active/completed và có link vào các file plan.md cùng phase-*.md.' },
    { labelEn: 'Stop launcher dashboard', labelVi: 'Dừng dashboard do launcher mở', command: '/ak:plans-kanban --stop',
      commandVi: '/ak:plans-kanban --stop', whenEn: 'Use when you need to stop a dashboard instance started by the launcher.', whenVi: 'Dùng khi cần dừng instance dashboard do launcher khởi động.', expectedEn: 'The launcher handles --stop for its managed dashboard instead of opening /plans, matching the troubleshooting guidance.', expectedVi: 'Launcher xử lý --stop cho dashboard nó quản lý thay vì mở /plans, đúng theo hướng dẫn troubleshooting.' },
  ],
