...
const data: SkillInfographic = {
  ...
  promptExamples: [
    ...
    { labelEn: "Parallel independent fixes", labelVi: "Sửa song song độc lập", command: "/ak:fix --parallel three unrelated CI failures", whenEn: "Two or more independent failures can be owned by separate workstreams.", whenVi: "Khi hai hay nhiều lỗi độc lập có thể thuộc workstream riêng.", expectedEn: "Splits independent issues with non-overlapping file ownership, fixes each stream, then reruns the combined repro and blast-radius checks.", expectedVi: "Tách các issue độc lập với ownership file không chồng lấn, sửa từng stream, rồi chạy lại repro tổng hợp và kiểm tra blast radius." },
  ],
};
