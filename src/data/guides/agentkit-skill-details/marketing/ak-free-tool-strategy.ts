...
const data: SkillInfographic = {
  ...
  promptExamples: [
    ...
    { labelEn: 'Generator idea', labelVi: 'Ý tưởng generator', command: '/ak:free-tool-strategy policy generator for small businesses',
      commandVi: '/ak:free-tool-strategy trình tạo chính sách cho doanh nghiệp nhỏ', whenEn: 'The audience repeatedly creates the same asset manually.', whenVi: 'Audience thường xuyên tạo thủ công cùng một loại tài sản.', expectedEn: 'It evaluates usefulness, buyer adjacency, the build path, and the follow-up sequence before committing to the idea.', expectedVi: 'Đánh giá giá trị sử dụng, độ gần với buyer, cách xây và chuỗi follow-up.' },
    { labelEn: 'Interactive resource', labelVi: 'Tài nguyên tương tác', command: '/ak:free-tool-strategy interactive tutorial for developer onboarding',
      commandVi: '/ak:free-tool-strategy hướng dẫn tương tác cho onboarding nhà phát triển', whenEn: 'Product education and authority are stronger goals than direct lead capture.', whenVi: 'Giáo dục sản phẩm và xây dựng uy tín quan trọng hơn lấy lead trực tiếp.', expectedEn: 'It plans an educational tool with SEO, sharing, and product integration working together in one experience.', expectedVi: 'Lập kế hoạch tool giáo dục với SEO, chia sẻ và tích hợp vào sản phẩm.' },
  ],
  specialOperations: [
