...
const data: SkillInfographic = {
  ...
  promptExamples: [
    { labelEn: 'Market decision', labelVi: 'Quyết định thị trường', command: '/ak:research-prompt Should we prioritize LinkedIn Ads or Google Search for a B2B SaaS launch?',
      commandVi: '/ak:research-prompt Chúng ta nên ưu tiên LinkedIn Ads hay Google Search cho buổi ra mắt SaaS B2B?', whenEn: 'You need a research assignment before choosing a marketing channel.', whenVi: 'Khi cần research assignment trước khi chọn kênh marketing.', expectedEn: 'One paragraph brief with context, decision, sub-questions, source rules, and output requirements.', expectedVi: 'Một đoạn brief có bối cảnh, quyết định, câu hỏi phụ, luật nguồn và yêu cầu output.', recommended: true },
    { labelEn: 'Pricing research', labelVi: 'Research pricing', command: '/ak:research-prompt Evidence needed to choose freemium vs free trial for our developer tool',
      commandVi: '/ak:research-prompt Bằng chứng cần thiết để chọn freemium vs dùng thử miễn phí cho công cụ dành cho nhà phát triển của chúng tôi', whenEn: 'A monetization decision needs source-backed research.', whenVi: 'Khi quyết định monetization cần research có nguồn.', expectedEn: 'A handoff-ready research paragraph focused on the decision, evidence needed, and expected output.', expectedVi: 'Đoạn research sẵn sàng handoff và tập trung vào quyết định, evidence cần có, cùng output mong đợi.' },
    { labelEn: 'Competitive research', labelVi: 'Research đối thủ', command: '/ak:research-prompt Compare referral program mechanics used by top PLG SaaS companies',
      commandVi: '/ak:research-prompt So sánh cơ chế chương trình giới thiệu được sử dụng bởi các công ty SaaS PLG hàng đầu', whenEn: 'You want another researcher to collect evidence, not guesses.', whenVi: 'Khi muốn researcher khác thu thập bằng chứng, không đoán.', expectedEn: 'Brief requiring primary sources, contradiction handling, per-finding relevance, and clear citation expectations.', expectedVi: 'Brief yêu cầu nguồn primary, xử lý mâu thuẫn và liên quan từng finding.' },
  ],
};
