...
const data: SkillInfographic = {
  ...
  promptExamples: [
    { labelEn: "Brand package", labelVi: "Bộ nhận diện", command: "/ak:design complete brand package for a new fintech",
      commandVi: '/ak:design bộ nhận diện thương hiệu hoàn chỉnh cho một fintech mới', whenEn: "Use when the request spans identity, logo, CIP, and presentation assets.", whenVi: "Dùng khi yêu cầu bao gồm identity, logo, CIP và tài sản trình bày.", expectedEn: "A routed brand package workflow through logo, CIP, and slides with consistent visual direction.", expectedVi: "Workflow bộ nhận diện được định tuyến qua logo, CIP và slide.", recommended: true },
    { labelEn: "Banner", labelVi: "Banner", command: "/ak:design LinkedIn launch banner for SaaS product",
      commandVi: '/ak:design Banner ra mắt LinkedIn cho sản phẩm SaaS', whenEn: "Use for platform-specific marketing banners.", whenVi: "Dùng cho banner marketing theo nền tảng cụ thể.", expectedEn: "Requirements intake, reference research, HTML/CSS or image generation, exact-dimension export, and review.", expectedVi: "Intake yêu cầu, nghiên cứu tham chiếu, tạo HTML/CSS hoặc hình ảnh, export đúng kích thước và review." },
    { labelEn: "Poster", labelVi: "Poster", command: "/ak:design poster for AI Conference",
      commandVi: '/ak:design poster cho Hội nghị AI', whenEn: "Use for event, editorial, marketing, or campaign posters.", whenVi: "Dùng cho poster sự kiện, editorial, marketing hoặc campaign.", expectedEn: "Style, palette, layout, texture, and model-ready prompt direction for the requested visual asset.", expectedVi: "Định hướng style, palette, layout, texture và prompt sẵn cho model theo asset người dùng cần." },
    { labelEn: "Icon set", labelVi: "Bộ icon", command: "/ak:design SVG icons for dashboard navigation",
      commandVi: '/ak:design Biểu tượng SVG cho điều hướng dashboard', whenEn: "Use for single icons or icon sets.", whenVi: "Dùng cho một icon hoặc bộ icon.", expectedEn: "SVG-oriented icon generation guidance with style, size, proportion, and export choices for reuse.", expectedVi: "Hướng dẫn tạo icon theo SVG với lựa chọn style và size." },
  ],
  skillStack: [
