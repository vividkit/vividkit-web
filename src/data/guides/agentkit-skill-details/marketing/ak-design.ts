...
const data: SkillInfographic = {
  ...
  promptExamples: [
    { labelEn: "Brand package", labelVi: "Bộ nhận diện", command: "/ak:design complete brand package for a new fintech", whenEn: "Use when the request spans identity, logo, CIP, and presentation assets.", whenVi: "Dùng khi yêu cầu bao gồm identity, logo, CIP và tài sản trình bày.", expectedEn: "A routed brand package workflow through logo, CIP, and slides.", expectedVi: "Workflow bộ nhận diện được định tuyến qua logo, CIP và slide.", recommended: true },
    ...
    { labelEn: "Poster", labelVi: "Poster", command: "/ak:design poster for AI Conference", whenEn: "Use for event, editorial, marketing, or campaign posters.", whenVi: "Dùng cho poster sự kiện, editorial, marketing hoặc campaign.", expectedEn: "Style, palette, layout, texture, and model-ready prompt direction.", expectedVi: "Định hướng style, palette, layout, texture và prompt sẵn cho model." },
    { labelEn: "Icon set", labelVi: "Bộ icon", command: "/ak:design SVG icons for dashboard navigation", whenEn: "Use for single icons or icon sets.", whenVi: "Dùng cho một icon hoặc bộ icon.", expectedEn: "SVG-oriented icon generation guidance with style and size choices.", expectedVi: "Hướng dẫn tạo icon theo SVG với lựa chọn style và size." },
  ],
  skillStack: [
