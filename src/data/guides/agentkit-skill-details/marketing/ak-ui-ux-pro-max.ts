  ...
  promptExamples: [
    {
      ...
      commandVi: '/ak:ui-ux-pro-max build hệ thống thiết kế trang landing SaaS',
    ...
    },
    {
      ...
      commandVi: '/ak:ui-ux-pro-max đánh giá màn hình ứng dụng di động này về khả năng truy cập và độ hoàn thiện',
    ...
    },
    {
      ...
      commandVi: '/ak:ui-ux-pro-max add biểu đồ bảng điều khiển phân tích',
