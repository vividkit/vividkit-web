...
const data: SkillInfographic = {
  ...
  promptExamples: [
    ...
    { labelEn: 'External scouting', labelVi: 'Scouting ngoài', command: '/ak:scout ext authentication module', whenEn: 'Native search is not enough and user-permitted external probes are appropriate.', whenVi: 'Khi native search không đủ và probe ngoài được phép là phù hợp.', expectedEn: 'External-probe-backed scout report with local evidence and clear confidence boundaries for follow-up work.', expectedVi: 'Scout report có hỗ trợ từ probe bên ngoài kèm evidence local và ranh giới confidence rõ.' },
