...
const data: SkillInfographic = {
  ...
  kit: 'marketer',
  header: {
    titleEn: '/ak:marketing-ideas — Context-fit growth idea selection',
    titleVi: '/ak:marketing-ideas — Chọn ý tưởng growth khớp ngữ cảnh',
  ...
  promptExamples: [{
      ...
      commandVi: '/ak:marketing-ideas SaaS phân tích B2B dành cho product managers',
    ...
    },
    {
      ...
      commandVi: '/ak:marketing-ideas danh sách chờ trước ra mắt cho công cụ viết AI',
