...
const data: SkillInfographic = {
  ...
  promptExamples: [
    ...
    { labelEn: 'Trivial issue', labelVi: 'Lỗi nhỏ', command: '/ak:fix "eslint no-unused-vars in src/app.ts" --quick', whenEn: 'The issue is a simple lint or type failure.', whenVi: 'Lỗi là lint hoặc type đơn giản.', expectedEn: 'Uses the quick scout to diagnose and repair the issue without skipping focused verification afterward.', expectedVi: 'Dùng khảo sát nhanh để chẩn đoán và sửa nhưng vẫn kiểm chứng.' },
