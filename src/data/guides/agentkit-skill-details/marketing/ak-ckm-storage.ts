...
const data: SkillInfographic = {
  ...
  processFlow: [
    ...
    { number: 4, titleEn: "Sync folders", titleVi: "Đồng bộ thư mục", descEn: "Use sync <folder> [remote-prefix] when local and bucket contents need to be reconciled.", descVi: "Dùng sync <folder> [remote-prefix] khi cần đồng bộ nội dung local với bucket." },
  ...
  promptExamples: [
    ...
    { labelEn: "Dry-run filtered sync", labelVi: "Dry-run sync có lọc", command: "/ak:ckm-storage sync assets/", whenEn: "Use when a local asset folder should be previewed and filtered before upload.", whenVi: "Dùng khi cần xem trước và lọc thư mục asset local trước khi upload.", expectedEn: "The sync workflow scans matching files and reports proposed object keys without uploading.", expectedVi: "Workflow sync quét file khớp bộ lọc và báo object key sẽ tạo, chưa upload." },
