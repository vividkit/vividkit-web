...
const data: SkillInfographic = {
  ...
  promptExamples: [
    { labelEn: "Default implementation", labelVi: "Triển khai mặc định", command: "/ak:cook Add user authentication to the app", whenEn: "Use when scope is known but should go through the default interactive workflow.", whenVi: "Dùng khi phạm vi đã rõ nhưng vẫn cần workflow interactive mặc định.", expectedEn: "Brainstorm contract, scout, plan, implementation, review, test, and finalize path tied to the requested feature.", expectedVi: "Luồng brainstorm contract, scout, plan, implement, review, test và finalize gắn với tính năng đã yêu cầu.", recommended: true },
