...
const data: SkillInfographic = {
  ...
  promptExamples: [
    { labelEn: 'Architecture flow', labelVi: 'Luồng kiến trúc', command: '/ak:mermaidjs-v11 flowchart for webhook ingestion pipeline',
      commandVi: '/ak:mermaidjs-v11 sơ đồ luồng cho pipeline tiếp nhận webhook', whenEn: 'Use when a process or architecture needs a Mermaid flowchart.', whenVi: 'Dùng khi cần flowchart Mermaid cho quy trình hoặc kiến trúc.', expectedEn: 'Returns valid Mermaid v11 flowchart syntax for the webhook ingestion pipeline, ready to render.', expectedVi: 'Trả cú pháp flowchart Mermaid v11 hợp lệ cho pipeline tiếp nhận webhook, sẵn sàng render.', recommended: true },
    { labelEn: 'API sequence', labelVi: 'Sequence API', command: '/ak:mermaidjs-v11 sequence diagram for checkout and webhook confirmation',
      commandVi: '/ak:mermaidjs-v11 sơ đồ tuần tự cho checkout và xác nhận webhook', whenEn: 'Use when actor interactions or API calls matter.', whenVi: 'Dùng khi cần thể hiện tương tác actor hoặc lời gọi API.', expectedEn: 'Returns a sequenceDiagram with named participants and request/response messages for checkout confirmation.', expectedVi: 'Trả sequenceDiagram có participant đặt tên và message request/response cho xác nhận checkout.' },
    { labelEn: 'Data model', labelVi: 'Mô hình dữ liệu', command: '/ak:mermaidjs-v11 er diagram for users orders and payments',
      commandVi: '/ak:mermaidjs-v11 sơ đồ er cho users orders và payments', whenEn: 'Use for entity relationships and database documentation.', whenVi: 'Dùng cho quan hệ entity và tài liệu database.', expectedEn: 'Returns ER diagram syntax with relationships and fields for users, orders, and payments.', expectedVi: 'Trả cú pháp ER diagram có quan hệ và field cho users, orders và payments.' },
  ],
