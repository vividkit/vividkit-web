...
const data: SkillInfographic = {
  ...
  promptExamples: [
    { labelEn: 'Architecture flow', labelVi: 'Luồng kiến trúc', command: '/ak:mermaidjs-v11 flowchart for webhook ingestion pipeline',
      commandVi: '/ak:mermaidjs-v11 sơ đồ luồng cho pipeline tiếp nhận webhook', whenEn: 'Use when a process or architecture needs a Mermaid flowchart.', whenVi: 'Dùng khi cần flowchart Mermaid cho quy trình hoặc kiến trúc.', expectedEn: 'Valid Mermaid v11 flowchart syntax.', expectedVi: 'Cú pháp flowchart Mermaid v11 hợp lệ.', recommended: true },
    { labelEn: 'API sequence', labelVi: 'Sequence API', command: '/ak:mermaidjs-v11 sequence diagram for checkout and webhook confirmation',
      commandVi: '/ak:mermaidjs-v11 sơ đồ tuần tự cho checkout và xác nhận webhook', whenEn: 'Use when actor interactions or API calls matter.', whenVi: 'Dùng khi cần thể hiện tương tác actor hoặc lời gọi API.', expectedEn: 'sequenceDiagram with participants and request/response messages.', expectedVi: 'sequenceDiagram có participant và message request/response.' },
    { labelEn: 'Data model', labelVi: 'Mô hình dữ liệu', command: '/ak:mermaidjs-v11 er diagram for users orders and payments',
      commandVi: '/ak:mermaidjs-v11 sơ đồ er cho users orders và payments', whenEn: 'Use for entity relationships and database documentation.', whenVi: 'Dùng cho quan hệ entity và tài liệu database.', expectedEn: 'ER diagram syntax with relationships and fields.', expectedVi: 'Cú pháp ER diagram có quan hệ và field.' },
  ],
