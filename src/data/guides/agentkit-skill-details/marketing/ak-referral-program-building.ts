...
const data: SkillInfographic = {
  ...
  promptExamples: [
    { labelEn: 'SaaS program', labelVi: 'Chương trình SaaS', command: '/ak:referral-program-building B2B SaaS referral program',
      commandVi: '/ak:referral-program-building chương trình giới thiệu B2B SaaS', whenEn: 'You need a referral loop for a subscription product.', whenVi: 'Khi cần referral loop cho sản phẩm subscription.', expectedEn: 'The referral program plan covers reward design, platform recommendation, tracking approach, fraud checks, and the KPI targets used to measure success.', expectedVi: 'Thiết kế reward, đề xuất nền tảng, hướng tracking, kiểm tra fraud và target KPI.', recommended: true },
    { labelEn: 'Product-aligned reward', labelVi: 'Reward gắn sản phẩm', command: '/ak:referral-program-building product credit rewards',
      commandVi: '/ak:referral-program-building phần thưởng credit sản phẩm', whenEn: 'You want incentives that reinforce product usage instead of pure cash payouts.', whenVi: 'Khi muốn incentive củng cố việc dùng sản phẩm thay vì chỉ trả tiền mặt.', expectedEn: 'It defines the reward structure, where referrals appear in the workflow, and the messaging used during launch.', expectedVi: 'Cấu trúc reward, vị trí trong workflow và thông điệp ra mắt.' },
    { labelEn: 'Existing program', labelVi: 'Chương trình hiện có', command: '/ak:referral-program-building optimize existing referral program',
      commandVi: '/ak:referral-program-building tối ưu chương trình giới thiệu hiện có', whenEn: 'A referral program exists but participation, CAC, CLV, or ROI needs improvement.', whenVi: 'Khi đã có referral program nhưng participation, CAC, CLV hoặc ROI cần cải thiện.', expectedEn: 'The optimization checklist reviews rewards, UX, tracking, fraud controls, and metrics so teams can improve the program over time.', expectedVi: 'Checklist tối ưu này đi qua reward, UX, tracking, fraud và metric để tìm điểm cần cải thiện.' },
  ],
  reportOutput: {
