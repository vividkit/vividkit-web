...
const data: SkillInfographic = {
  ...
  promptExamples: [{ labelEn: "Campaign report", labelVi: "Báo cáo campaign", command: "/ak:analytics campaign performance",
      commandVi: '/ak:analytics campaign performance', whenEn: "A campaign needs KPI, ROI, and channel-performance analysis.", whenVi: "Khi campaign cần phân tích KPI, ROI và hiệu suất theo kênh.", expectedEn: "Produce a structured performance readout with comparable metrics, insights, and prioritized actions drawn from the available results.", expectedVi: "Báo cáo hiệu suất có cấu trúc với metric so sánh được, insight và hành động ưu tiên.", recommended: true },
    { labelEn: "ROI analysis", labelVi: "Phân tích ROI", command: "/ak:analytics ROI report",
      commandVi: '/ak:analytics báo cáo ROI', whenEn: "Marketing spend needs to be tied to conversions, revenue, and attribution assumptions.", whenVi: "Khi cần nối spend marketing với conversion, doanh thu và giả định attribution.", expectedEn: "Show ROI calculations with attribution caveats, benchmarks, and recommended budget moves so spending decisions stay grounded.", expectedVi: "Tính ROI kèm lưu ý attribution, benchmark và đề xuất chuyển ngân sách." },
    { labelEn: 'CAC vs LTV', labelVi: 'CAC so với LTV', command: '/ak:analytics CAC vs LTV last 90 days',
      commandVi: '/ak:analytics CAC vs LTV 90 ngày qua', whenEn: 'You need a KPI readout with comparable timeframe and a decision, not a vanity chart.', whenVi: 'Khi cần đọc KPI theo khung thời gian so sánh được và ra quyết định, không phải chart cho có.', expectedEn: 'Provide ratio calculations, fair comparison notes, and a recommended next action after the figures are compared.', expectedVi: 'Tính tỷ lệ, ghi chú so sánh công bằng và hành động tiếp theo.' }
  ],
  skillStack: [
    { name: "GA4", type: 'tool' },
