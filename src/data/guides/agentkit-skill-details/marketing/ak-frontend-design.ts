...
const data: SkillInfographic = {
  ...
  promptExamples: [
    { labelEn: "From-scratch interface", labelVi: "Giao diện từ đầu", command: "/ak:frontend-design design and build a distinctive landing page for our observability product",
      commandVi: '/ak:frontend-design thiết kế và xây dựng một trang đích đặc sắc cho sản phẩm quan sát của chúng tôi', whenEn: "Visual polish and differentiation matter more than routine implementation.", whenVi: "Độ chỉn chu hình ảnh và khác biệt quan trọng hơn triển khai thông thường.", expectedEn: "Declares design read, seed, thesis, tokens, implements a real UI, and passes the self-review gate.", expectedVi: "Tuyên bố cách đọc, seed, thesis, token, triển khai UI thật và vượt self-review gate.", recommended: true },
