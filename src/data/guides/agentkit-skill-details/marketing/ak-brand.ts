...
const data: SkillInfographic = {
  ...
  promptExamples: [
    { labelEn: "Update brand", labelVi: "Cập nhật brand", command: "/ak:brand update",
      commandVi: '/ak:brand update', whenEn: "Brand guidelines need to change and sync into design tokens.", whenVi: "Khi guideline brand cần thay đổi và sync vào design token.", expectedEn: "Provide updated docs/brand-guidelines.md plus assets/design-tokens.json and assets/design-tokens.css sync evidence showing the written tokens stay aligned.", expectedVi: "Nộp docs/brand-guidelines.md đã cập nhật cùng bằng chứng sync assets/design-tokens.json và assets/design-tokens.css để đối chiếu token.", recommended: true },
