...
const data: SkillInfographic = {
  ...
  promptExamples: [
    { labelEn: 'Fast plan', labelVi: 'Plan nhanh', command: '/ak:plan fast Launch a webinar funnel for founders',
      commandVi: '/ak:plan fast Ra mắt phễu webinar cho founders', whenEn: 'The work is clear and does not need research.', whenVi: 'Khi công việc rõ và không cần research.', expectedEn: 'Concise implementation plan from an enhanced task prompt.', expectedVi: 'Implementation plan súc tích từ prompt đã được làm rõ.', recommended: true },
    { labelEn: 'Hard plan', labelVi: 'Plan sâu', command: '/ak:plan hard Build a cross-channel launch system for a new SaaS product',
      commandVi: '/ak:plan hard Xây dựng hệ thống ra mắt đa kênh cho sản phẩm SaaS mới', whenEn: 'The task needs research, assumptions, and deeper analysis.', whenVi: 'Khi task cần research, giả định và phân tích sâu hơn.', expectedEn: 'Research-backed plan with open questions listed at the end.', expectedVi: 'Plan có research hỗ trợ và câu hỏi mở ở cuối.' },
    { labelEn: 'Parallel plan', labelVi: 'Plan song song', command: '/ak:plan parallel Create content, ads, landing page, and email launch assets',
      commandVi: '/ak:plan parallel Tạo nội dung, quảng cáo, trang đích và tài sản ra mắt email', whenEn: 'Independent workstreams should be planned for concurrent execution.', whenVi: 'Khi nhiều luồng việc độc lập cần được lập kế hoạch để chạy đồng thời.', expectedEn: 'Plan broken into parallel-executable phases with dependencies.', expectedVi: 'Plan chia thành các phase chạy song song được, kèm dependency.' },
    { labelEn: 'Two approaches', labelVi: 'Hai phương án', command: '/ak:plan two Improve activation for a self-serve SaaS trial',
      commandVi: '/ak:plan two Cải thiện kích hoạt cho dùng thử SaaS tự phục vụ', whenEn: 'You want two viable approaches before choosing direction.', whenVi: 'Khi muốn có hai hướng khả thi trước khi chọn.', expectedEn: 'Two researched approaches with tradeoffs and decision criteria.', expectedVi: 'Hai phương án có research, tradeoff và tiêu chí quyết định.' },
    { labelEn: 'Validate plan', labelVi: 'Kiểm chứng plan', command: '/ak:plan validate plans/launch-plan.md',
      commandVi: '/ak:plan validate plans/launch-plan.md', whenEn: 'A plan exists and needs critical-question review.', whenVi: 'Khi đã có plan và cần review bằng câu hỏi phản biện.', expectedEn: 'Validation interview exposing gaps and unresolved questions.', expectedVi: 'Phỏng vấn kiểm chứng làm lộ gap và câu hỏi còn mở.' },
  ],
};
