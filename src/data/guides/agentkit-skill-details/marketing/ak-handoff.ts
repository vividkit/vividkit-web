...
const data: SkillInfographic = {
  ...
  promptExamples: [
    ...
    { labelEn: 'Explicit path', labelVi: 'Đường dẫn cụ thể', command: '/ak:handoff --output plans/reports/handoff-oauth-callback.md --force', whenEn: 'The artifact should overwrite a known handoff path intentionally.', whenVi: 'Cần cố ý ghi đè một đường dẫn handoff đã biết.', expectedEn: 'Writes the exact requested path only because --force permits overwrite of the existing handoff.', expectedVi: 'Ghi đúng đường dẫn đã yêu cầu vì --force cho phép ghi đè handoff hiện có.' },
  ],
  skillStack: [
