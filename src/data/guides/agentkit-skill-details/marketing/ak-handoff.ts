...
const data: SkillInfographic = {
  ...
  promptExamples: [
    ...
    { labelEn: 'Focused handoff', labelVi: 'Handoff có trọng tâm', command: '/ak:handoff "continue the OAuth callback fix"', whenEn: 'A specific task focus should appear in the goal and filename slug.', whenVi: 'Cần đưa một trọng tâm công việc cụ thể vào goal và slug tên file.', expectedEn: 'Creates a focused continuation contract for that task.', expectedVi: 'Tạo hợp đồng tiếp tục tập trung vào việc đó.' },
    ...
    { labelEn: 'Explicit path', labelVi: 'Đường dẫn cụ thể', command: '/ak:handoff --output plans/reports/handoff-oauth-callback.md --force', whenEn: 'The artifact should overwrite a known handoff path intentionally.', whenVi: 'Cần cố ý ghi đè một đường dẫn handoff đã biết.', expectedEn: 'Writes the exact path only because --force permits overwrite.', expectedVi: 'Ghi đúng đường dẫn đó vì --force cho phép ghi đè.' },
  ],
  skillStack: [
