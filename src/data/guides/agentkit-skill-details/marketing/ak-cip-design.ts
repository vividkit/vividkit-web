...
const data: SkillInfographic = {
  ...
  promptExamples: [
    { labelEn: "Recommended start", labelVi: "Cách bắt đầu khuyến nghị", command: "/ak:cip-design complete CIP for Grand Vista luxury hotel",
      commandVi: '/ak:cip-design hoàn thành CIP cho khách sạn sang trọng Grand Vista', whenEn: "Use when the brand needs a complete applied identity package.", whenVi: "Dùng khi brand cần một bộ nhận diện ứng dụng đầy đủ.", expectedEn: "Prepare an industry-fit brief, style direction, and prioritized CIP deliverables that match the stated business context.", expectedVi: "Brief hợp ngành, hướng phong cách và danh sách hạng mục CIP ưu tiên.", recommended: true },
    { labelEn: "Specific deliverable", labelVi: "Hạng mục cụ thể", command: "/ak:cip-design business card and letterhead for TopGroup consulting",
      commandVi: '/ak:cip-design danh thiếp và tiêu đề thư cho TopGroup consulting', whenEn: "Use when only selected identity touchpoints need mockups.", whenVi: "Dùng khi chỉ cần mockup cho vài điểm chạm nhận diện cụ thể.", expectedEn: "Supply mockup guidance for the requested deliverables and brand context during the visual design review.", expectedVi: "Hướng dẫn mockup cho các hạng mục đã yêu cầu và bối cảnh brand." },
    { labelEn: "Brand application", labelVi: "Ứng dụng thương hiệu", command: "/ak:cip-design vehicle branding for GreenLeaf organic food",
      commandVi: '/ak:cip-design thương hiệu xe cho GreenLeaf thực phẩm hữu cơ', whenEn: "Use for applied identity on vehicles, signage, packaging, or apparel.", whenVi: "Dùng cho nhận diện ứng dụng trên xe, biển hiệu, bao bì hoặc đồng phục.", expectedEn: "State CIP recommendations matched to the deliverable category and industry without drifting from either constraint.", expectedVi: "Đưa khuyến nghị CIP khớp với nhóm hạng mục và ngành để mỗi gợi ý đúng phạm vi." },
  ],
  skillStack: [
