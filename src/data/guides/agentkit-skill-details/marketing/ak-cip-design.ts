...
const data: SkillInfographic = {
  ...
  processFlow: [
    ...
    { number: 6, titleEn: "Select model", titleVi: "Chọn model", descEn: "Use flash for fast economical outputs, or pro when higher quality and 4K text rendering matter.", descVi: "Dùng flash để ra nhanh và tiết kiệm, hoặc pro khi cần chất lượng cao và chữ 4K rõ hơn." },
