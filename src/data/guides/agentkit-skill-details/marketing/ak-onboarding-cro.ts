...
const data: SkillInfographic = {
  ...
  kit: 'marketer',
  header: {
    titleEn: '/ak:onboarding-cro — Post-signup onboarding and activation CRO',
    titleVi: '/ak:onboarding-cro — CRO onboarding và activation sau signup',
  ...
  promptExamples: [
    {
      ...
      commandVi: '/ak:onboarding-cro luồng onboarding cho SaaS quản lý dự án của chúng tôi',
    ...
    },
    {
      ...
      commandVi: '/ak:onboarding-cro thiết kế lại danh sách kiểm tra lần chạy đầu cho thiết lập phân tích',
