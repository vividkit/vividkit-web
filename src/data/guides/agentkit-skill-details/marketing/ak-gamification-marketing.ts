...
const data: SkillInfographic = {
  ...
  promptExamples: [
    ...
    { labelEn: 'Referral leaderboard', labelVi: 'Leaderboard referral', command: '/ak:gamification-marketing referral leaderboard for acquisition',
      commandVi: '/ak:gamification-marketing bảng xếp hạng referral cho acquisition', whenEn: 'Acquisition should use referrals, dual rewards, and social proof.', whenVi: 'Acquisition cần dùng referral, thưởng hai phía và social proof.', expectedEn: 'It designs the mechanics, psychology, reward rules, and toxicity safeguards that shape the engagement loop.', expectedVi: 'Thiết kế cơ chế, tâm lý, luật thưởng và cách tránh cạnh tranh độc hại.' },
    { labelEn: 'Onboarding progress', labelVi: 'Tiến độ onboarding', command: '/ak:gamification-marketing onboarding progress bars and micro-badges',
      commandVi: '/ak:gamification-marketing thanh tiến trình onboarding và micro-badges', whenEn: 'New users need momentum through setup or activation.', whenVi: 'Người dùng mới cần cảm giác tiến triển qua bước setup hoặc activation.', expectedEn: 'It uses progress bars, micro-badges, unlockables, templates, and activation KPIs to track how people advance.', expectedVi: 'Thiết kế dùng progress bar, micro-badge, unlockable, template và KPI activation để thấy người dùng tiến tới kích hoạt.' },
  ],
  specialOperations: [
