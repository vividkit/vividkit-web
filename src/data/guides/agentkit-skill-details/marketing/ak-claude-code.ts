...
const data: SkillInfographic = {
  ...
  kit: 'marketer',
  header: {
    titleEn: "Claude Code reference navigator",
    titleVi: "Bộ tra cứu Claude Code",
  ...
  promptExamples: [
    { labelEn: "Install and authenticate", labelVi: "Cài đặt và đăng nhập", command: "/ak:claude-code installation and authentication", whenEn: "Use when setting up Claude Code for the first time.", whenVi: "Dùng khi thiết lập Claude Code lần đầu.", expectedEn: "Guidance from the getting-started reference.", expectedVi: "Hướng dẫn dựa trên tài liệu getting-started.", recommended: true },
    { labelEn: "Create a skill", labelVi: "Tạo skill", command: "/ak:claude-code creating Agent Skills", whenEn: "Use when building or packaging a SKILL.md with bundled resources.", whenVi: "Dùng khi tạo hoặc đóng gói SKILL.md cùng tài nguyên đi kèm.", expectedEn: "Skill structure and metadata guidance from the Agent Skills reference.", expectedVi: "Hướng dẫn cấu trúc skill và metadata từ tài liệu Agent Skills." },
    { labelEn: "MCP setup", labelVi: "Thiết lập MCP", command: "/ak:claude-code MCP server configuration", whenEn: "Use when connecting Claude Code to external tools.", whenVi: "Dùng khi kết nối Claude Code với công cụ bên ngoài.", expectedEn: "Configuration and authentication advice for MCP integrations.", expectedVi: "Lời khuyên về cấu hình và xác thực cho tích hợp MCP." },
    { labelEn: "Troubleshooting", labelVi: "Gỡ lỗi", command: "/ak:claude-code troubleshooting authentication failures", whenEn: "Use when Claude Code auth, performance, or debug behavior is failing.", whenVi: "Dùng khi auth, hiệu năng hoặc debug của Claude Code gặp lỗi.", expectedEn: "A reference-backed diagnosis path, not a guess.", expectedVi: "Một luồng chẩn đoán có tài liệu chống lưng, không đoán mò." },
  ],
  skillStack: [
