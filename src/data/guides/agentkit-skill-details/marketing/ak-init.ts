...
const data: SkillInfographic = {
  ...
  promptExamples: [
    { labelEn: 'New project', labelVi: 'Dự án mới', command: '/ak:init new DTC skincare brand launch',
      commandVi: '/ak:init ra mắt thương hiệu chăm sóc da DTC mới', whenEn: 'Starting a marketing project with little existing structure.', whenVi: 'Bắt đầu dự án marketing gần như chưa có cấu trúc.', expectedEn: 'It runs setup, research, an interview, minimal docs generation, and next-action suggestions in that opening sequence.', expectedVi: 'Chạy setup, nghiên cứu, phỏng vấn, tạo tài liệu tối thiểu và gợi ý bước tiếp theo.', recommended: true },
    ...
    { labelEn: 'Website-based brief', labelVi: 'Brief dựa trên website', command: '/ak:init marketing brief from existing website and brand assets',
      commandVi: '/ak:init brief marketing từ website và tài sản thương hiệu hiện có', whenEn: 'Brand and design inputs should be extracted from live or existing materials.', whenVi: 'Cần rút brand và thiết kế từ website hoặc tài liệu hiện có.', expectedEn: 'It includes website extraction, brand asset review, and structured interview follow-up while the starting context is collected.', expectedVi: 'Bao gồm trích xuất website, xem brand asset và phỏng vấn bổ sung có cấu trúc.' },
  ],
  skillStack: [
