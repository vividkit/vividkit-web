...
const data: SkillInfographic = {
  ...
  promptExamples: [
    { labelEn: 'Product discovery', labelVi: 'Khám phá sản phẩm', command: '/ak:play create idea-check --template product-discovery',
      commandVi: '/ak:play create idea-check --template product-discovery', whenEn: 'A founder or product owner needs the discovery playbook before a campaign playbook.', whenVi: 'Khi founder hoặc product owner cần playbook khám phá trước playbook chiến dịch.', expectedEn: 'Creates a product-discovery playbook whose publish, send, and spend steps stay behind a founder-decision or human-approval gate.', expectedVi: 'Tạo playbook product-discovery mà các bước publish, gửi hoặc chi tiêu vẫn nằm sau cổng quyết định của founder hoặc phê duyệt của người.' },
