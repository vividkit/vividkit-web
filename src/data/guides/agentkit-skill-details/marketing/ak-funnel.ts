...
const data: SkillInfographic = {
  ...
  kit: 'marketer',
  header: {
    titleEn: '/ak:funnel — Funnel Design and Optimization',
    titleVi: '/ak:funnel — Thiết kế và tối ưu funnel',
  ...
  promptExamples: [
    { labelEn: 'Lead magnet funnel', labelVi: 'Funnel lead magnet', command: '/ak:funnel design lead-magnet',
      commandVi: '/ak:funnel thiết kế lead-magnet', whenEn: 'A new gated asset should capture and nurture leads.', whenVi: 'Một tài sản gated mới cần thu và nurture lead.', expectedEn: 'Designs traffic, landing page, capture, nurture, sales, checkout, follow-up, and metrics.', expectedVi: 'Thiết kế traffic, landing page, thu lead, nurture, bán hàng, checkout, follow-up và chỉ số.', recommended: true },
    { labelEn: 'Webinar funnel', labelVi: 'Funnel webinar', command: '/ak:funnel design webinar',
      commandVi: '/ak:funnel thiết kế webinar', whenEn: 'A webinar needs registration, reminders, attendance, and follow-up flow.', whenVi: 'Webinar cần luồng đăng ký, nhắc lịch, tham dự và follow-up.', expectedEn: 'Creates a webinar funnel with stage definitions and measurement.', expectedVi: 'Tạo funnel webinar với từng giai đoạn và cách đo.' },
    { labelEn: 'Analyze funnel', labelVi: 'Phân tích funnel', command: '/ak:funnel analyze',
      commandVi: '/ak:funnel analyze', whenEn: 'An existing funnel has metrics but unclear drop-off causes.', whenVi: 'Funnel hiện có có số liệu nhưng chưa rõ nguyên nhân rớt.', expectedEn: 'Calculates conversion by stage and identifies drop-off points.', expectedVi: 'Tính conversion theo giai đoạn và tìm điểm rớt.' },
    { labelEn: 'Optimize funnel', labelVi: 'Tối ưu funnel', command: '/ak:funnel optimize',
      commandVi: '/ak:funnel optimize', whenEn: 'You need prioritized conversion improvements and A/B tests.', whenVi: 'Cần cải thiện chuyển đổi có ưu tiên và đề xuất A/B test.', expectedEn: 'Ranks improvements and produces test suggestions.', expectedVi: 'Xếp hạng đề xuất cải thiện và tạo ý tưởng test.' },
  ],
  skillStack: [
