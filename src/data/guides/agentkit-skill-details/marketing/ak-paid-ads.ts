...
const data: SkillInfographic = {
  ...
  promptExamples: [
    ...
    { labelEn: 'LinkedIn lead gen', labelVi: 'Lead gen LinkedIn', command: '/ak:paid-ads LinkedIn Lead Gen',
      commandVi: '/ak:paid-ads Tạo lead LinkedIn', whenEn: 'You sell B2B and job title, seniority, company size, or industry targeting matters.', whenVi: 'Khi bán B2B và cần nhắm theo chức danh, cấp bậc, quy mô công ty hoặc ngành.', expectedEn: 'Lead Gen Form strategy, audience sizing, realistic CPC assumptions, and conversion setup.', expectedVi: 'Chiến lược Lead Gen Form, sizing audience, giả định CPC thực tế và setup chuyển đổi.' },
  ],
  reportOutput: {
