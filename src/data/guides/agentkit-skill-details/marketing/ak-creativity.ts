...
const data: SkillInfographic = {
  ...
  promptExamples: [
    { labelEn: "Campaign direction", labelVi: "Định hướng campaign", command: "/ak:creativity TikTok campaign for Gen Z SaaS product launch",
      commandVi: '/ak:creativity chiến dịch TikTok cho ra mắt sản phẩm SaaS Gen Z', whenEn: "Use when a campaign needs style, platform, voice, audio, and effects direction.", whenVi: "Dùng khi campaign cần định hướng style, nền tảng, giọng, âm thanh và hiệu ứng.", expectedEn: "A creative brief with recommendations and anti-patterns states the intended direction and the patterns to avoid.", expectedVi: "Creative brief có khuyến nghị và anti-pattern nêu hướng làm việc cùng các điều nên tránh khi sáng tạo.", recommended: true },
    { labelEn: "Luxury style", labelVi: "Phong cách luxury", command: "/ak:creativity luxury premium hotel video",
      commandVi: '/ak:creativity video khách sạn sang trọng cao cấp', whenEn: "Use when the brand goal is premium perception.", whenVi: "Dùng khi mục tiêu brand là tạo cảm nhận cao cấp.", expectedEn: "Style, color, music, and platform guidance suitable for premium audiences directs look, sound, and platform fit.", expectedVi: "Hướng dẫn style, màu sắc, âm nhạc và nền tảng phù hợp audience cao cấp." },
    { labelEn: "UGC direction", labelVi: "Định hướng UGC", command: "/ak:creativity authentic UGC community campaign",
      commandVi: '/ak:creativity chiến dịch cộng đồng UGC chân thực', whenEn: "Use when relatability and community trust matter more than polish.", whenVi: "Dùng khi sự gần gũi và niềm tin cộng đồng quan trọng hơn độ bóng bẩy.", expectedEn: "Raw, relatable creative direction with production checks keeps the idea grounded and confirms it can be produced.", expectedVi: "Định hướng creative thô mộc, dễ đồng cảm kèm checklist sản xuất." },
  ],
};
