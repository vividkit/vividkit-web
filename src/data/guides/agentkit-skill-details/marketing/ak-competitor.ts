...
const data: SkillInfographic = {
  ...
  promptExamples: [
    ...
    { labelEn: "Tracked list", labelVi: "Danh sách theo dõi", command: "/ak:competitor list",
      commandVi: '/ak:competitor list', whenEn: "Use to see tracked competitors.", whenVi: "Dùng để xem các đối thủ đang được theo dõi.", expectedEn: "A tracked competitor list.", expectedVi: "Danh sách đối thủ đang theo dõi." },
  ],
  skillStack: [
