...
const data: SkillInfographic = {
  ...
  kit: 'marketer',
  header: {
    titleEn: '/ak:competitor — Competitive intelligence and comparison content',
    titleVi: '/ak:competitor — Phân tích đối thủ và nội dung so sánh',
  ...
  promptExamples: [
    { labelEn: "Analyze competitor", labelVi: "Phân tích đối thủ", command: "/ak:competitor analyze https://competitor.com",
      commandVi: '/ak:competitor analyze https://competitor.com', whenEn: "Use when you need broad competitor intelligence.", whenVi: "Dùng khi cần phân tích đối thủ tổng quát.", expectedEn: "Write a competitor report covering positioning, pricing, audience, channels, strengths, and weaknesses for the named rivals.", expectedVi: "Report đối thủ gồm định vị, giá, audience, kênh, điểm mạnh và điểm yếu.", recommended: true },
    { labelEn: "Content gap", labelVi: "Khoảng trống nội dung", command: "/ak:competitor content https://competitor.com",
      commandVi: '/ak:competitor content https://competitor.com', whenEn: "Use when planning content against competitor coverage.", whenVi: "Dùng khi lên nội dung dựa trên phần đối thủ đang phủ.", expectedEn: "Identify topics, formats, and opportunities your content can target where competitors leave a visible gap.", expectedVi: "Chủ đề, định dạng và cơ hội mà nội dung của bạn có thể nhắm tới." },
    { labelEn: "SEO comparison", labelVi: "So sánh SEO", command: "/ak:competitor seo https://competitor.com",
      commandVi: '/ak:competitor seo https://competitor.com', whenEn: "Use when search visibility needs competitor context.", whenVi: "Dùng khi cần đặt khả năng hiển thị tìm kiếm vào bối cảnh đối thủ.", expectedEn: "Provide an SEO comparison across rankings, backlinks, authority, and content quality for the competing domains.", expectedVi: "So sánh SEO theo thứ hạng, backlink, authority và chất lượng nội dung." },
    { labelEn: "Alternatives page", labelVi: "Trang alternative", command: "/ak:competitor alternatives notion",
      commandVi: '/ak:competitor các lựa chọn thay thế notion', whenEn: "Use to produce competitor alternative or vs comparison content.", whenVi: "Dùng để tạo nội dung alternative hoặc so sánh vs đối thủ.", expectedEn: "The comparison page structure is backed by competitor and product research that grounds the finished comparison page.", expectedVi: "Cấu trúc trang so sánh dựa trên nghiên cứu đối thủ và sản phẩm." },
    { labelEn: "Tracked list", labelVi: "Danh sách theo dõi", command: "/ak:competitor list",
      commandVi: '/ak:competitor list', whenEn: "Use to see tracked competitors.", whenVi: "Dùng để xem các đối thủ đang được theo dõi.", expectedEn: "A tracked competitor list holds the competitors that remain under active observation for later comparison.", expectedVi: "Danh sách đối thủ đang theo dõi lưu những đối thủ còn được quan sát để dùng khi so sánh sau." },
  ],
  skillStack: [
