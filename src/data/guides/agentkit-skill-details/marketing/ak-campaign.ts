...
const data: SkillInfographic = {
  ...
  kit: 'marketer',
  header: {
    titleEn: "Campaign command center",
    titleVi: "Trung tâm điều phối chiến dịch",
  ...
  promptExamples: [
    { labelEn: "Create campaign", labelVi: "Tạo chiến dịch", command: "/ak:campaign create Summer Launch", whenEn: "Use when a new multi-channel campaign needs brief, funnel, and creative planning.", whenVi: "Dùng khi cần tạo chiến dịch đa kênh mới với brief, funnel và kế hoạch creative.", expectedEn: "A structured campaign workspace with briefs and creatives under assets/campaigns.", expectedVi: "Một workspace campaign có cấu trúc, gồm brief và creative trong assets/campaigns.", recommended: true },
    { labelEn: "Campaign status", labelVi: "Trạng thái chiến dịch", command: "/ak:campaign status Summer Launch", whenEn: "Use when campaign files already exist and you need progress summarized.", whenVi: "Dùng khi đã có hồ sơ campaign và cần tóm tắt tiến độ.", expectedEn: "Progress, blockers, and next actions from the campaign files.", expectedVi: "Tiến độ, điểm nghẽn và hành động tiếp theo từ hồ sơ campaign." },
    { labelEn: "Performance analysis", labelVi: "Phân tích hiệu suất", command: "/ak:campaign analyze Summer Launch", whenEn: "Use when metrics or channel performance need diagnosis.", whenVi: "Dùng khi cần chẩn đoán chỉ số hoặc hiệu suất theo kênh.", expectedEn: "A performance report and campaign audit recommendations.", expectedVi: "Báo cáo hiệu suất và khuyến nghị audit campaign." },
    { labelEn: "Email campaign", labelVi: "Chiến dịch email", command: "/ak:campaign email Summer Launch", whenEn: "Use for email campaign creation or management inside the campaign.", whenVi: "Dùng để tạo hoặc quản lý email trong chiến dịch.", expectedEn: "Email campaign assets aligned to the broader campaign plan.", expectedVi: "Tài sản email bám sát kế hoạch chiến dịch tổng thể." },
  ],
  skillStack: [
