...
const data: SkillInfographic = {
  ...
  promptExamples: [
    { labelEn: "Create campaign", labelVi: "Tạo chiến dịch", command: "/ak:campaign create Summer Launch",
      commandVi: '/ak:campaign create Ra mắt Mùa hè', whenEn: "Use when a new multi-channel campaign needs brief, funnel, and creative planning.", whenVi: "Dùng khi cần tạo chiến dịch đa kênh mới với brief, funnel và kế hoạch creative.", expectedEn: "Assemble a structured campaign workspace with briefs and creatives under assets/campaigns for the active campaign.", expectedVi: "Một workspace campaign có cấu trúc, gồm brief và creative trong assets/campaigns.", recommended: true },
    { labelEn: "Campaign status", labelVi: "Trạng thái chiến dịch", command: "/ak:campaign status Summer Launch",
      commandVi: '/ak:campaign status Ra mắt Mùa hè', whenEn: "Use when campaign files already exist and you need progress summarized.", whenVi: "Dùng khi đã có hồ sơ campaign và cần tóm tắt tiến độ.", expectedEn: "Summarize progress, blockers, and next actions from the campaign files in a clear status update.", expectedVi: "Tiến độ, điểm nghẽn và hành động tiếp theo từ hồ sơ campaign." },
    { labelEn: "Performance analysis", labelVi: "Phân tích hiệu suất", command: "/ak:campaign analyze Summer Launch",
      commandVi: '/ak:campaign analyze Ra mắt Mùa hè', whenEn: "Use when metrics or channel performance need diagnosis.", whenVi: "Dùng khi cần chẩn đoán chỉ số hoặc hiệu suất theo kênh.", expectedEn: "Write a performance report and campaign audit recommendations that explain what the campaign should change.", expectedVi: "Lập báo cáo hiệu suất và khuyến nghị audit campaign dựa trên kết quả chiến dịch đã ghi." },
    { labelEn: "Email campaign", labelVi: "Chiến dịch email", command: "/ak:campaign email Summer Launch",
      commandVi: '/ak:campaign email Ra mắt Mùa hè', whenEn: "Use for email campaign creation or management inside the campaign.", whenVi: "Dùng để tạo hoặc quản lý email trong chiến dịch.", expectedEn: "Create email campaign assets aligned to the broader campaign plan and keep their message on that plan.", expectedVi: "Soạn tài sản email bám sát kế hoạch chiến dịch tổng thể để thông điệp không lệch hướng." },
  ],
  skillStack: [
