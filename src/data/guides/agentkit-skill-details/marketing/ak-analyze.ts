...
const data: SkillInfographic = {
  ...
  processFlow: [
    ...
    { number: 8, titleEn: "Write report", titleVi: "Viết báo cáo", descEn: "Save standard analyses to reports/analytics/{date}-{type}.md and report-route output to reports/periodic/{date}-{period}.md.", descVi: "Lưu phân tích thường vào reports/analytics/{date}-{type}.md và output route report vào reports/periodic/{date}-{period}.md." },
  ],
  corePrinciplesEn: [
  ...
  reportOutput: {
    ...
    patternEn: "reports/analytics/{date}-{type}.md and reports/periodic/{date}-{period}.md",
    patternVi: "reports/analytics/{date}-{type}.md và reports/periodic/{date}-{period}.md",
    descEn: "The skill writes type-specific analytics reports and periodic report-route outputs with insights and recommendations.",
    descVi: "Skill ghi báo cáo analytics theo từng loại và output định kỳ của route report, kèm insight và khuyến nghị.",
  },
};
