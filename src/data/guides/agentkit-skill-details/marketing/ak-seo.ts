...
const data: SkillInfographic = {
  ...
  promptExamples: [
    { labelEn: 'Audit', labelVi: 'Audit', command: '/ak:seo audit https://example.com',
      commandVi: '/ak:seo audit https://example.com', whenEn: 'You need a technical SEO review for a site or page.', whenVi: 'Khi cần review technical SEO cho site hoặc page.', expectedEn: 'The SEO audit report covers crawl behavior, index status, technical problems, on-page issues, and CWV findings.', expectedVi: 'Báo cáo SEO audit bao gồm crawl, index, technical, on-page và vấn đề CWV.', recommended: true },
    { labelEn: 'Keywords', labelVi: 'Keyword', command: '/ak:seo keywords product analytics software',
      commandVi: '/ak:seo keywords phần mềm phân tích sản phẩm', whenEn: 'You need keyword demand, clusters, and content planning.', whenVi: 'Khi cần demand keyword, cluster và kế hoạch content.', expectedEn: 'The keyword report includes search volume, difficulty, CPC, topic clusters, and content gaps found during research.', expectedVi: 'Báo cáo keyword này gồm volume, difficulty, CPC, cluster và gap để hỗ trợ quyết định nội dung.' },
    { labelEn: 'pSEO', labelVi: 'pSEO', command: '/ak:seo pseo city landing pages',
      commandVi: '/ak:seo pseo trang đích theo thành phố', whenEn: 'You want scalable page templates for programmatic SEO.', whenVi: 'Khi muốn template page scale được cho programmatic SEO.', expectedEn: 'This deliverable provides the pSEO template and the URL strategy that supports scalable landing page creation.', expectedVi: 'Tài liệu này cung cấp template pSEO và chiến lược URL nhằm mở rộng việc tạo trang đích.' },
    { labelEn: 'Schema request', labelVi: 'Request schema', command: '/ak:seo schema pricing page',
      commandVi: '/ak:seo schema trang định giá', whenEn: 'Use only as a scoped JSON-LD request after checking the bundled tool effect.', whenVi: 'Chỉ dùng như request JSON-LD có scope rõ sau khi kiểm tra effect của tool đóng gói.', expectedEn: 'It offers schema guidance or an artifact path, and it clearly notes where the effect boundary applies.', expectedVi: 'Nội dung này đưa hướng dẫn schema hoặc path artifact và ghi rõ ranh giới effect liên quan.' },
  ],
  reportOutput: {
    titleEn: 'SEO Outputs',
    titleVi: 'Output SEO',
