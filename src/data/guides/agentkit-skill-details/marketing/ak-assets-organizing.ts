...
const data: SkillInfographic = {
  ...
  promptExamples: [{ labelEn: "Organize a campaign", labelVi: "Tổ chức campaign", command: "/ak:assets-organizing campaign assets",
      commandVi: '/ak:assets-organizing tài sản chiến dịch', whenEn: "A campaign will produce briefs, creatives, reports, and source assets.", whenVi: "Khi campaign sẽ tạo brief, creative, report và source asset.", expectedEn: "Prepare a folder and naming plan under assets/campaigns with collision checks before any campaign files are placed.", expectedVi: "Kế hoạch folder và tên file dưới assets/campaigns, có kiểm tra trùng.", recommended: true },
    { labelEn: "Place a report", labelVi: "Đặt vị trí báo cáo", command: "/ak:assets-organizing analytics report",
      commandVi: '/ak:assets-organizing báo cáo phân tích', whenEn: "A report needs the correct durable path and filename pattern.", whenVi: "Khi báo cáo cần đúng path lưu bền vững và pattern tên file.", expectedEn: "Record the correct reports path, slug/date format, and pre-output checklist that must be confirmed prior to export.", expectedVi: "Ghi rõ path báo cáo đúng, format slug/ngày và checklist trước khi xuất để file báo cáo không bị đặt sai." },
    { labelEn: 'Launch asset library', labelVi: 'Thư viện asset launch', command: '/ak:assets-organizing organize launch campaign assets',
      commandVi: '/ak:assets-organizing tổ chức tài sản chiến dịch ra mắt', whenEn: 'Campaign files need a consistent folder, naming, and reuse map.', whenVi: 'File chiến dịch cần thư mục, naming và bản đồ tái sử dụng nhất quán.', expectedEn: 'Specify classification, destination paths, and naming for the launch asset set so each file lands correctly.', expectedVi: 'Nêu phân loại, đường dẫn đích và naming cho bộ asset launch trước khi sắp xếp file.' }
  ],
};
