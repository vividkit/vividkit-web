  ...
  promptExamples: [
    {
      ...
      commandVi: '/ak:tech-graph sơ đồ kiến trúc cho pipeline RAG',
    ...
    },
    {
      ...
      commandVi: '/ak:tech-graph sơ đồ tuần tự của luồng thanh toán checkout',
    ...
    },
    {
      ...
      commandVi: '/ak:tech-graph bản đồ khái niệm cho các loại bộ nhớ agent',
  ...
  outputFlags: [
    {
      ...
      exampleCommand: "/ak:tech-graph Draw a data-flow diagram --output ./docs/diagrams/",
          exampleCommandVi: '/ak:tech-graph Vẽ sơ đồ luồng dữ liệu --output ./docs/diagrams/'
    }
  ]
};
