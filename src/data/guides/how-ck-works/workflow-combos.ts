...
export const workflowCombos: WorkflowCombo[] = [
  ...
  {
    id: 'advise-then-build',
    kit: 'engineer',
    titleEn: 'Advise → Plan → Cook',
    titleVi: 'Advise → Plan → Cook',
    descEn: 'Pressure-test the idea, plan with gates, then implement',
    descVi: 'Pressure-test ý tưởng, plan có gate, rồi implement',
    scenarios: ['advise', 'plan', 'cook'],
    category: 'sequential',
    icon: '<path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/>',
    accentColor: 'violet',
    tipEn: 'advise is advisory-only; /clear between plan and cook',
    tipVi: 'advise chỉ advisory; /clear giữa plan và cook',
  },

  {
    id: 'issue-audited-plan',
    kit: 'engineer',
    titleEn: 'Issue → Audited Plan',
    titleVi: 'Issue → Plan Đã Audit',
    descEn: 'Hard-gated issue-to-plan, then cook only after human approval',
    descVi: 'issue-to-plan có hard gate, chỉ cook sau khi người duyệt',
    scenarios: ['issue-to-plan', 'cook'],
    category: 'sequential',
    icon: '<circle cx="18" cy="18" r="3"/><circle cx="6" cy="6" r="3"/><path d="M6 9v6a3 3 0 0 0 3 3h6"/>',
    accentColor: 'sky',
    tipEn: 'issue-to-plan never implements — stop at plan branch',
    tipVi: 'issue-to-plan không bao giờ implement — dừng ở plan branch',
  },

  {
    id: 'long-run-goal-preflight',
    kit: 'engineer',
    titleEn: 'Long-Run Goal Preflight',
    titleVi: 'Preflight Goal Long-Run',
    descEn: 'Optional advise (fuzzy only) → goal-warmup → codex-goal wording (user starts /goal)',
    descVi: 'advise tùy chọn (chỉ goal mơ hồ) → goal-warmup → wording codex-goal (user tự start /goal)',
    scenarios: ['advise', 'goal-warmup', 'codex-goal'],
    category: 'sequential',
    icon: '<circle cx="12" cy="12" r="10"/><circle cx="12" cy="12" r="6"/><circle cx="12" cy="12" r="2"/>',
    accentColor: 'amber',
    tipEn: 'Clear goal? Skip advise → goal-warmup only. Fuzzy? advise first. Never auto-start /goal; stop unless Ready.',
    tipVi: 'Goal đã rõ? Bỏ advise → chỉ goal-warmup. Goal mơ hồ? advise trước. Không tự start /goal; dừng trừ khi Ready.',
  },

  {
    id: 'session-continuity',
    kit: 'engineer',
    titleEn: 'Session Continuity',
    titleVi: 'Liên Tục Session',
    descEn: 'Conversation handoff + optional git status + subfolder context',
    descVi: 'Handoff hội thoại + status git tùy chọn + context subfolder',
    scenarios: ['handoff', 'watzup', 'folder-context'],
    category: 'sequential',
    icon: '<path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/>',
    accentColor: 'orange',
    tipEn: 'handoff ≠ watzup — conversation state vs git-derived report',
    tipVi: 'handoff ≠ watzup — state hội thoại vs report từ git',
  },

  {
    id: 'multi-agent-orchestration',
    kit: 'engineer',
    titleEn: 'Multi-Agent Coding',
    titleVi: 'Coding Multi-Agent',
    descEn: 'Orchestrate agents, then integrate with code-review and tests',
    descVi: 'Điều phối agents, rồi integrate bằng code-review và tests',
    scenarios: ['coding-agent-orchestration', 'code-review', 'test'],
    category: 'sequential',
    icon: '<path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/>',
    accentColor: 'purple',
    tipEn: 'Define file ownership before --parallel work',
    tipVi: 'Định file ownership trước khi chạy --parallel',
  },
