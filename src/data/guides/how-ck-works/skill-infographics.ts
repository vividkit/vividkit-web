    ...
    promptExamples: [
      {
        ...
        commandVi: '/ck:brainstorm Choose the best auth approach for our current SaaS app',
      ...
      },
      {
        ...
        commandVi: '/ck:plan Create an implementation plan for the auth approach we selected in brainstorm, using the report just created as context',
      ...
      },
      {
        ...
        commandVi: '/ck:plan plans/reports/brainstorm-260524-1908-auth-approach.md',
    ...
    promptExamples: [
      {
        ...
        commandVi: '/ck:plan Redesign checkout flow to reduce payment failures',
      ...
      },
      {
        ...
        commandVi: '/ck:plan --fast Change the CTA copy in the Pricing section',
      ...
      },
      {
        ...
        commandVi: '/ck:plan --hard Refactor auth flow while preserving backward compatibility',
      ...
      },
      {
        ...
        commandVi: '/ck:plan --deep Split billing into subscription, invoice, webhook modules',
      ...
      },
      {
        ...
        commandVi: '/ck:plan --parallel Optimize dashboard loading and chart rendering',
      ...
      },
      {
        ...
        commandVi: '/ck:plan --two Choose an offline-first data sync architecture',
      ...
      },
      {
        ...
        commandVi: '/ck:plan --deep --tdd Refactor the billing module',
      ...
      },
      {
        ...
        commandVi: '/ck:plan --fast --no-tasks Update guide copy',
      ...
      // Extra flag card prompt examples — used by infographic-plan-quick-ref.astro flag cards
      {
        ...
        commandVi: '/ck:plan --deep --tdd Refactor billing module',
    ...
    promptExamples: [
      {
        ...
        commandVi: '/ck:cook /abs/plans/260524-auth/plan.md',
      ...
      },
      {
        ...
        commandVi: '/ck:cook Add email/password login with httpOnly session',
      ...
      },
      {
        ...
        commandVi: '/ck:cook --tdd Refactor billing calculation while preserving behavior',
    ...
    promptExamples: [
      {
        ...
        commandVi: '/ck:fix Login submit returns 500 in local dev',
      ...
      },
      {
        ...
        commandVi: '/ck:fix --review Payment webhook double-charges paid orders',
      ...
      },
      {
        ...
        commandVi: '/ck:fix --quick npm run build fails after latest merge',
    ...
    promptExamples: [
      {
        ...
        commandVi: '/ck:team --research "Evaluate three caching strategies for our API gateway"',
      ...
      },
      {
        ...
        commandVi: '/ck:team --cook "Implement auth, dashboard, and notification modules"',
      ...
      },
      {
        ...
        commandVi: '/ck:team --review "Audit the payment module for security and correctness"',
      ...
      },
      {
        ...
        commandVi: '/ck:team --debug "Investigate intermittent 502 errors in production API"',
      ...
      // Template card prompts — used by infographic-team-quick-ref.astro template cards
      {
        ...
        commandVi: '/ck:team research Compare auth strategies for our SaaS app',
      ...
      },
      {
        ...
        commandVi: '/ck:team cook plans/.../plan.md --devs 4 --worktree',
      ...
      },
      {
        ...
        commandVi: '/ck:team review src/api --reviewers 3',
      ...
      },
      {
        ...
        commandVi: '/ck:team debug "Webhook returns 500 intermittently" --debuggers 3',
    ...
    promptExamples: [
      {
        ...
        commandVi: '/ck:preview --explain How does the auth middleware chain work in this repo',
      ...
      },
      {
        ...
        commandVi: '/ck:preview --diagram Data flow from webhook to notification queue',
      ...
      },
      {
        ...
        commandVi: '/ck:preview --html --slides Step-by-step guide to our deployment pipeline',
      ...
      },
      {
        ...
        commandVi: '/ck:preview --html --diff main',
      ...
      // Flag card prompts — used by infographic-preview-quick-ref.astro flag group items
      {
        ...
        commandVi: '/ck:preview plans/.../plan.md',
      ...
      },
      {
        ...
        commandVi: '/ck:preview plans/260527-.../',
      ...
      },
      {
        ...
        commandVi: '/ck:preview src/auth/middleware.ts',
      ...
      },
      {
        ...
        commandVi: '/ck:preview --html --diagram "DB schema"',
      ...
      },
      {
        ...
        commandVi: '/ck:preview --diff HEAD~3',
      ...
      },
      {
        ...
        commandVi: '/ck:preview --plan-review plans/.../plan.md',
      ...
      },
      {
        ...
        commandVi: '/ck:preview --recap "last week"',
      ...
      },
      {
        ...
        commandVi: '/ck:preview --slides "onboarding flow"',
      ...
      },
      {
        ...
        commandVi: '/ck:preview --ascii "folder structure"',
    ...
    promptExamples: [
      {
        ...
        commandVi: '/ck:code-review --pending',
      ...
      },
      {
        ...
        commandVi: '/ck:code-review codebase parallel',
