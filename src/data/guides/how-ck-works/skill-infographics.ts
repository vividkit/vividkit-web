  ...
  // ─────────────────────────────────────────────────────────────────────────────
  {
    ...
    outputFlags: [
      ...
      },
      {
        ...
        descVi: 'Sau khi report local đã có, publish markdown + HTML qua agentwiki CLI hoặc MCP. Bỏ qua sạch sẽ khi không khả dụng.',
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  {
    ...
    outputFlags: [
      ...
      },
      {
        ...
        descVi: 'Publish plan docs đã review cuối hoặc plan.html lên AgentWiki qua CLI hoặc MCP khi khả dụng. Bỏ qua sạch sẽ (không chặn tạo plan) khi không khả dụng.',
