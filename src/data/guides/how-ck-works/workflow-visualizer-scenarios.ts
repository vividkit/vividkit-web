...
export const workflowScenarios: WorkflowScenario[] = [
  ...
  // ─── /ck:chrome-devtools — Chrome Devtools ─────────────────────────────
  {
    id: 'chrome-devtools',
    command: '/ck:chrome-devtools',
    kit: 'engineer',
    titleEn: 'Chrome Devtools',
    titleVi: 'Chrome Devtools',
    descEn: 'Browser automation, debugging, and performance analysis using Puppeteer CLI scripts. Use for automating browsers, taking screenshots, analyzing performance, monitoring network traffic, web scraping, form automation, and JavaScript debugging.',
    descVi: 'Tự động hóa browser, debug, và phân tích performance với Puppeteer CLI. Dùng để chụp màn hình, theo dõi network traffic, scraping, tự động hóa form, và debug JavaScript.',
    ...
    steps: [
      {
        ...
        descEn: 'Invoke /ck:chrome-devtools with a concrete task brief',
        descVi: 'Gọi /ck:chrome-devtools với brief task cụ thể',
        explainEn: '/ck:chrome-devtools starts the Chrome Devtools flow. The user provides the target, constraints, and expected artifact so the agent can route the work without guessing.\n\nPrimary surface: Browser automation, debugging, and performance analysis using Puppeteer CLI scripts. Use for automating browsers, taking screenshots, analyzing performance, monitoring network traffic, web scraping, form automation, and JavaScript debugging.',
        explainVi: '/ck:chrome-devtools bắt đầu flow Chrome Devtools. User đưa target, ràng buộc, và artifact mong đợi để agent route công việc không phải đoán.\n\nBề mặt chính: Browser automation, debugging, and performance analysis using Puppeteer CLI scripts. Use for automating browsers, taking screenshots, analyzing performance, monitoring network traffic, web scraping, form automation, and JavaScript debugging.',
        codeSnippet: '> /ck:chrome-devtools \'Chrome Devtools for this project\'\n\n// Include target, constraints, and desired artifact',
        icon: '<polyline points=\'4 17 10 11 4 5\'/><line x1=\'12\' y1=\'19\' x2=\'20\' y2=\'19\'/>',
        color: 'purple'
      },
      {
        ...
        explainEn: 'Before the Engineer Kit work starts, hooks and project instructions provide the operating boundary: current repo context, privacy checks, active plans, and validation expectations.\n\nThis keeps the flow tied to the real workspace instead of producing generic advice.',
      ...
      },
      {
        ...
        explainEn: 'The main agent executes the selected /ck:chrome-devtools path. It may use specialist skills, local tools, or sub-agents when the source workflow requires research, review, testing, design, or generation.\n\nThe work stays scoped to the selected route and records assumptions when data is unavailable.',
        explainVi: 'Main agent thực thi path /ck:chrome-devtools đã chọn. Nó có thể dùng specialist skills, local tools, hoặc sub-agent khi workflow cần research, review, test, design, hoặc generation.\n\nCông việc giữ đúng scope route đã chọn và ghi assumptions khi thiếu dữ liệu.',
  ...
  // ─── /ck:tech-graph — Tech Graph ─────────────────────────────
  {
    ...
    titleVi: 'Tech Graph',
    descEn: '>-',
    descVi: 'Tạo diagram kiến trúc kỹ thuật chất lượng cao dạng SVG/PNG.',
    icon: '<path d="M12 2a10 10 0 0 0-7 17.12"/><path d="M12 2a10 10 0 0 1 7 17.12"/><path d="M2 12h20"/><path d="M12 2c2.5 2.8 4 6.2 4 10s-1.5 7.2-4 10"/><path d="M12 2c-2.5 2.8-4 6.2-4 10s1.5 7.2 4 10"/>',
    accentColor: 'slate',
    steps: [
      {
        ...
        type: 'user-input',
        name: '/ck:tech-graph',
        descEn: 'Invoke /ck:tech-graph with a concrete task brief',
        descVi: 'Gọi /ck:tech-graph với brief task cụ thể',
        explainEn: '/ck:tech-graph starts the Tech Graph flow. The user provides the target, constraints, and expected artifact so the agent can route the work without guessing.\n\nPrimary surface: >-',
        explainVi: '/ck:tech-graph bắt đầu flow Tech Graph. User đưa target, ràng buộc, và artifact mong đợi để agent route công việc không phải đoán.\n\nBề mặt chính: >-',
        codeSnippet: '> /ck:tech-graph \'Tech Graph for this project\'\n\n// Include target, constraints, and desired artifact',
        icon: '<polyline points=\'4 17 10 11 4 5\'/><line x1=\'12\' y1=\'19\' x2=\'20\' y2=\'19\'/>',
        color: 'purple'
      },
      {
      ...
      },
      {
        ...
        descEn: 'Run the selected workflow path and produce the requested artifact',
        descVi: 'Chạy workflow path đã chọn và tạo artifact yêu cầu',
        explainEn: 'The main agent executes the selected /ck:tech-graph path. It may use specialist skills, local tools, or sub-agents when the source workflow requires research, review, testing, design, or generation.\n\nThe work stays scoped to the selected route and records assumptions when data is unavailable.',
        explainVi: 'Main agent thực thi path /ck:tech-graph đã chọn. Nó có thể dùng specialist skills, local tools, hoặc sub-agent khi workflow cần research, review, test, design, hoặc generation.\n\nCông việc giữ đúng scope route đã chọn và ghi assumptions khi thiếu dữ liệu.',
        codeSnippet: '// Execute selected route\n// Use specialist skill/tool only when needed\n// Record assumptions and unavailable data\n// Keep changes/artifacts scoped',
        icon: '<path d=\'M12 2a10 10 0 0 0-7 17.12\'/><path d=\'M12 2a10 10 0 0 1 7 17.12\'/><path d=\'M2 12h20\'/><path d=\'M12 2c2.5 2.8 4 6.2 4 10s-1.5 7.2-4 10\'/><path d=\'M12 2c-2.5 2.8-4 6.2-4 10s1.5 7.2 4 10\'/>',
        color: 'green',
        isSubAgent: false
  ...
  // ─── /ck:template-skill — Template Skill ─────────────────────────────
  {
    id: 'template-skill',
    command: '/ck:template-skill',
    kit: 'engineer',
    titleEn: 'Template Skill',
    titleVi: 'Template Skill',
    descEn: 'Replace with description of the skill and when Claude should use it.',
    descVi: 'Thay bằng mô tả skill và thời điểm Claude nên sử dụng.',
    icon: '<path d="M12 2a10 10 0 0 0-7 17.12"/><path d="M12 2a10 10 0 0 1 7 17.12"/><path d="M2 12h20"/><path d="M12 2c2.5 2.8 4 6.2 4 10s-1.5 7.2-4 10"/><path d="M12 2c-2.5 2.8-4 6.2-4 10s1.5 7.2 4 10"/>',
    accentColor: 'stone',
    steps: [
      {
        ...
        descEn: 'Invoke /ck:template-skill with a concrete task brief',
        descVi: 'Gọi /ck:template-skill với brief task cụ thể',
        explainEn: '/ck:template-skill starts the Template Skill flow. The user provides the target, constraints, and expected artifact so the agent can route the work without guessing.\n\nPrimary surface: Replace with description of the skill and when Claude should use it.',
        explainVi: '/ck:template-skill bắt đầu flow Template Skill. User đưa target, ràng buộc, và artifact mong đợi để agent route công việc không phải đoán.\n\nBề mặt chính: Replace with description of the skill and when Claude should use it.',
        codeSnippet: '> /ck:template-skill \'Template Skill for this project\'\n\n// Include target, constraints, and desired artifact',
        icon: '<polyline points=\'4 17 10 11 4 5\'/><line x1=\'12\' y1=\'19\' x2=\'20\' y2=\'19\'/>',
        color: 'purple'
      },
      {
      ...
      },
      {
        ...
        descEn: 'Run the selected workflow path and produce the requested artifact',
        descVi: 'Chạy workflow path đã chọn và tạo artifact yêu cầu',
        explainEn: 'The main agent executes the selected /ck:template-skill path. It may use specialist skills, local tools, or sub-agents when the source workflow requires research, review, testing, design, or generation.\n\nThe work stays scoped to the selected route and records assumptions when data is unavailable.',
        explainVi: 'Main agent thực thi path /ck:template-skill đã chọn. Nó có thể dùng specialist skills, local tools, hoặc sub-agent khi workflow cần research, review, test, design, hoặc generation.\n\nCông việc giữ đúng scope route đã chọn và ghi assumptions khi thiếu dữ liệu.',
        codeSnippet: '// Execute selected route\n// Use specialist skill/tool only when needed\n// Record assumptions and unavailable data\n// Keep changes/artifacts scoped',
        icon: '<path d=\'M12 2a10 10 0 0 0-7 17.12\'/><path d=\'M12 2a10 10 0 0 1 7 17.12\'/><path d=\'M2 12h20\'/><path d=\'M12 2c2.5 2.8 4 6.2 4 10s-1.5 7.2-4 10\'/><path d=\'M12 2c-2.5 2.8-4 6.2-4 10s1.5 7.2 4 10\'/>',
        color: 'green',
        isSubAgent: false
  ...
  // ─── /ckm:ab-test-setup — AB Test Setup ─────────────────────────────
  {
    ...
    descEn: 'When the user wants to plan, design, or implement an A/B test or experiment. Also use when the user mentions "A/B test," "split test," "experiment," "test this change," "variant copy," "multivariate test," or "hypothesis." For tracking implementation, see analytics-tracking.',
    descVi: 'Lập kế hoạch, thiết kế hoặc triển khai A/B test. Dùng khi đề cập đến "split test", "experiment", "multivariate test", hay "hypothesis". Xem analytics-tracking để triển khai tracking.',
    icon: '<path d="M12 2a10 10 0 0 0-7 17.12"/><path d="M12 2a10 10 0 0 1 7 17.12"/><path d="M2 12h20"/><path d="M12 2c2.5 2.8 4 6.2 4 10s-1.5 7.2-4 10"/><path d="M12 2c-2.5 2.8-4 6.2-4 10s1.5 7.2 4 10"/>',
    accentColor: 'orange',
    steps: [
      {
      ...
      },
      {
        ...
        descEn: 'Project rules, active plans, permissions, and safety constraints are loaded',
        descVi: 'Load project rules, plan đang active, permissions, và ràng buộc an toàn',
        explainEn: 'Before the Marketing Kit work starts, hooks and project instructions provide the operating boundary: current repo context, privacy checks, active plans, and validation expectations.\n\nThis keeps the flow tied to the real workspace instead of producing generic advice.',
  ...
  // ─── /ckm:ads-management — ADS Management ─────────────────────────────
  {
    ...
    descVi: 'Quản lý quảng cáo trả phí trên Google Ads, Meta, LinkedIn, TikTok. Bao gồm copywriting, nhắm mục tiêu, tối ưu ngân sách, A/B testing, ROAS tracking, và tạo creative asset bằng AI.',
    icon: '<path d="M12 2a10 10 0 0 0-7 17.12"/><path d="M12 2a10 10 0 0 1 7 17.12"/><path d="M2 12h20"/><path d="M12 2c2.5 2.8 4 6.2 4 10s-1.5 7.2-4 10"/><path d="M12 2c-2.5 2.8-4 6.2-4 10s1.5 7.2 4 10"/>',
    accentColor: 'lime',
    steps: [
      {
  ...
  // ─── /ckm:affiliate-marketing — Affiliate Marketing ─────────────────────────────
  {
    ...
    descVi: 'Xây dựng chương trình affiliate SaaS tỷ lệ chuyển đổi cao với hoa hồng 20-40%, hợp tác KOL/KOC, và ngăn chặn gian lận. Bao gồm chọn platform, cấu trúc hoa hồng, chiến lược tiếp cận influencer.',
    icon: '<path d="M12 2a10 10 0 0 0-7 17.12"/><path d="M12 2a10 10 0 0 1 7 17.12"/><path d="M2 12h20"/><path d="M12 2c2.5 2.8 4 6.2 4 10s-1.5 7.2-4 10"/><path d="M12 2c-2.5 2.8-4 6.2-4 10s1.5 7.2 4 10"/>',
    accentColor: 'emerald',
    steps: [
      {
  ...
  // ─── /ckm:analytics — Analytics ─────────────────────────────
  {
    ...
    titleEn: 'Analytics',
    titleVi: 'Analytics',
    descEn: 'Activate for marketing analytics, KPI tracking, reporting dashboards, attribution analysis, and performance optimization. Use when analyzing campaign data, creating reports, or measuring marketing ROI.',
    descVi: 'Phân tích marketing, theo dõi KPI, dashboard báo cáo, attribution analysis và tối ưu hiệu suất. Dùng khi phân tích dữ liệu chiến dịch, tạo report, hoặc đo ROI marketing.',
    icon: '<path d="M12 2a10 10 0 0 0-7 17.12"/><path d="M12 2a10 10 0 0 1 7 17.12"/><path d="M2 12h20"/><path d="M12 2c2.5 2.8 4 6.2 4 10s-1.5 7.2-4 10"/><path d="M12 2c-2.5 2.8-4 6.2-4 10s1.5 7.2 4 10"/>',
    accentColor: 'amber',
    steps: [
      {
  ...
  // ─── /ckm:analyze — Analyze ─────────────────────────────
  {
    ...
    descVi: '💡💡 Phân tích dữ liệu và báo cáo hiệu suất.',
    icon: '<path d="M12 2a10 10 0 0 0-7 17.12"/><path d="M12 2a10 10 0 0 1 7 17.12"/><path d="M2 12h20"/><path d="M12 2c2.5 2.8 4 6.2 4 10s-1.5 7.2-4 10"/><path d="M12 2c-2.5 2.8-4 6.2-4 10s1.5 7.2 4 10"/>',
    accentColor: 'blue',
    steps: [
      {
  ...
  // ─── /ckm:assets-organizing — Assets Organizing ─────────────────────────────
  {
    ...
    descVi: 'Sắp xếp toàn bộ output từ slash commands và subagents vào thư mục assets/ theo chủ đề, định dạng ngày, và slug.',
    icon: '<path d="M12 2a10 10 0 0 0-7 17.12"/><path d="M12 2a10 10 0 0 1 7 17.12"/><path d="M2 12h20"/><path d="M12 2c2.5 2.8 4 6.2 4 10s-1.5 7.2-4 10"/><path d="M12 2c-2.5 2.8-4 6.2-4 10s1.5 7.2 4 10"/>',
    accentColor: 'purple',
    steps: [
      {
  ...
  // ─── /ckm:banner-design — Banner Design ─────────────────────────────
  {
    ...
    descVi: 'Thiết kế banner cho mạng xã hội, quảng cáo, website hero, và in ấn. Nhiều phong cách art direction với hình ảnh AI tạo ra. Hỗ trợ Facebook, LinkedIn, YouTube, Instagram, Google Display.',
    icon: '<path d="M12 2a10 10 0 0 0-7 17.12"/><path d="M12 2a10 10 0 0 1 7 17.12"/><path d="M2 12h20"/><path d="M12 2c2.5 2.8 4 6.2 4 10s-1.5 7.2-4 10"/><path d="M12 2c-2.5 2.8-4 6.2-4 10s1.5 7.2 4 10"/>',
    accentColor: 'pink',
    steps: [
      {
  ...
  // ─── /ckm:brand — Brand ─────────────────────────────
  {
    ...
    titleEn: 'Brand',
    titleVi: 'Brand',
    descEn: 'Brand voice, visual identity, messaging frameworks, asset management, brand consistency. Activate for branded content, tone of voice, marketing assets, brand compliance, style guides.',
    descVi: 'Giọng điệu thương hiệu, nhận diện hình ảnh, messaging framework, quản lý asset, và nhất quán thương hiệu. Dùng cho nội dung có thương hiệu, tone of voice, style guide.',
    icon: '<path d="M12 2a10 10 0 0 0-7 17.12"/><path d="M12 2a10 10 0 0 1 7 17.12"/><path d="M2 12h20"/><path d="M12 2c2.5 2.8 4 6.2 4 10s-1.5 7.2-4 10"/><path d="M12 2c-2.5 2.8-4 6.2-4 10s1.5 7.2 4 10"/>',
    accentColor: 'slate',
    steps: [
      {
  ...
  // ─── /ckm:cip-design — CIP Design ─────────────────────────────
  {
    ...
    titleEn: 'CIP Design',
    titleVi: 'CIP Design',
    descEn: 'Corporate Identity Program design with 50 deliverables, 20 styles, 20 industries. Generate CIP mockups with Gemini Nano Banana (Flash/Pro). Actions: design, create, generate brand identity. Deliverables: business card, letterhead, signage, vehicle, apparel, packaging. Styles: corporate, luxury, minimal, modern.',
    descVi: 'Thiết kế bộ nhận diện doanh nghiệp (CIP) với 50 ấn phẩm, 20 phong cách, 20 ngành. Tạo mockup CIP với AI. Bao gồm danh thiếp, tiêu đề thư, bảng hiệu, phương tiện, trang phục, bao bì.',
    icon: '<path d="M12 2a10 10 0 0 0-7 17.12"/><path d="M12 2a10 10 0 0 1 7 17.12"/><path d="M2 12h20"/><path d="M12 2c2.5 2.8 4 6.2 4 10s-1.5 7.2-4 10"/><path d="M12 2c-2.5 2.8-4 6.2-4 10s1.5 7.2 4 10"/>',
    accentColor: 'zinc',
    steps: [
      {
      ...
      },
      {
        ...
        descEn: 'Read relevant files, docs, inputs, and route options before action',
        descVi: 'Đọc files, docs, input, và route options liên quan trước khi làm',
        explainEn: 'The agent audits the request against local files and the command surface. Important flags or routes are captured before execution: --logo.\n\nFor broad tasks, it narrows scope and lists the exact output expected before creating artifacts.',
        explainVi: 'Agent audit request với local files và bề mặt command. Flags hoặc routes quan trọng được chốt trước khi chạy: --logo.\n\nVới task rộng, agent thu scope và liệt kê output cụ thể trước khi tạo artifact.',
        codeSnippet: '// Audit checklist:\n// - locate relevant project files\n// - identify route/options: --logo\n// - confirm output format and save path\n// - avoid unrelated edits',
        icon: '<circle cx=\'11\' cy=\'11\' r=\'8\'/><line x1=\'21\' y1=\'21\' x2=\'16.65\' y2=\'16.65\'/>',
        color: 'green',
        isSubAgent: false
      },
  ...
  // ─── /ckm:claude-code — Claude Code ─────────────────────────────
  {
    ...
    descVi: 'Dùng khi hỏi về cài đặt Claude Code, slash commands, Agent Skills, MCP servers, hooks, tích hợp IDE (VS Code, JetBrains), CI/CD workflows, deploy enterprise, hoặc tính năng nâng cao.',
    icon: '<path d="M12 2a10 10 0 0 0-7 17.12"/><path d="M12 2a10 10 0 0 1 7 17.12"/><path d="M2 12h20"/><path d="M12 2c2.5 2.8 4 6.2 4 10s-1.5 7.2-4 10"/><path d="M12 2c-2.5 2.8-4 6.2-4 10s1.5 7.2 4 10"/>',
    accentColor: 'teal',
    steps: [
      {
  ...
  // ─── /ckm:competitor — Competitor ─────────────────────────────
  {
    ...
    descVi: 'Phân tích cạnh tranh, trang so sánh alternatives, nội dung SEO đối thủ, định vị thị trường, và tạo battlecard.',
    icon: '<path d="M12 2a10 10 0 0 0-7 17.12"/><path d="M12 2a10 10 0 0 1 7 17.12"/><path d="M2 12h20"/><path d="M12 2c2.5 2.8 4 6.2 4 10s-1.5 7.2-4 10"/><path d="M12 2c-2.5 2.8-4 6.2-4 10s1.5 7.2 4 10"/>',
    accentColor: 'cyan',
    steps: [
      {
  ...
  // ─── /ckm:content-hub — Content HUB ─────────────────────────────
  {
    ...
    titleEn: 'Content HUB',
    titleVi: 'Content HUB',
    descEn: 'Browser-based asset gallery for managing marketing assets. Visual grid with filter/search, brand context sidebar, and actions (preview, edit, generate). R2-ready manifest for future cloud sync. Use when browsing assets, managing content library, or generating new assets with brand context.',
    descVi: 'Thư viện asset marketing trên trình duyệt. Grid trực quan với filter/search, sidebar brand context, và các hành động (preview, edit, generate). Dùng để duyệt asset, quản lý content library.',
    icon: '<path d="M12 2a10 10 0 0 0-7 17.12"/><path d="M12 2a10 10 0 0 1 7 17.12"/><path d="M2 12h20"/><path d="M12 2c2.5 2.8 4 6.2 4 10s-1.5 7.2-4 10"/><path d="M12 2c-2.5 2.8-4 6.2-4 10s1.5 7.2 4 10"/>',
    accentColor: 'sky',
    steps: [
      {
  ...
  // ─── /ckm:content-marketing — Content Marketing ─────────────────────────────
  {
    ...
    descEn: 'Activate for content strategy, editorial calendars, content pillar mapping, blog planning, and content audit. Use when planning content programs, creating editorial workflows, or building topic clusters.',
    descVi: 'Chiến lược nội dung, lịch editorial, content pillar mapping, lập kế hoạch blog, và audit nội dung. Dùng khi xây dựng chương trình content, workflow editorial, hoặc topic cluster.',
    icon: '<path d="M12 2a10 10 0 0 0-7 17.12"/><path d="M12 2a10 10 0 0 1 7 17.12"/><path d="M2 12h20"/><path d="M12 2c2.5 2.8 4 6.2 4 10s-1.5 7.2-4 10"/><path d="M12 2c-2.5 2.8-4 6.2-4 10s1.5 7.2 4 10"/>',
    accentColor: 'indigo',
    steps: [
      {
  ...
  // ─── /ckm:creativity — Creativity ─────────────────────────────
  {
    ...
    titleEn: 'Creativity',
    titleVi: 'Creativity',
    descEn: 'Creative direction intelligence. 55 styles, 18 platforms, 12 voiceover types, 17 music genres, 30 campaign categories. Actions: create, design, plan, direct, brief creative campaigns. Projects: ads, videos, social content, commercials, brand films. Styles: minimalist, maximalist, nostalgic, cinematic, UGC, luxury, futuristic, emotional. Topics: visual style, platform specs, voiceover, music, color palette, audience targeting.',
    descVi: 'Trí tuệ định hướng sáng tạo. 55 phong cách, 18 platform, 30 danh mục chiến dịch. Lên ý tưởng, brief và định hướng creative cho ads, video, social content, thương hiệu.',
    icon: '<path d="M12 2a10 10 0 0 0-7 17.12"/><path d="M12 2a10 10 0 0 1 7 17.12"/><path d="M2 12h20"/><path d="M12 2c2.5 2.8 4 6.2 4 10s-1.5 7.2-4 10"/><path d="M12 2c-2.5 2.8-4 6.2-4 10s1.5 7.2 4 10"/>',
    accentColor: 'violet',
    steps: [
      {
      ...
      },
      {
        ...
        descEn: 'Read relevant files, docs, inputs, and route options before action',
        descVi: 'Đọc files, docs, input, và route options liên quan trước khi làm',
        explainEn: 'The agent audits the request against local files and the command surface. Important flags or routes are captured before execution: --creative-brief.\n\nFor broad tasks, it narrows scope and lists the exact output expected before creating artifacts.',
        explainVi: 'Agent audit request với local files và bề mặt command. Flags hoặc routes quan trọng được chốt trước khi chạy: --creative-brief.\n\nVới task rộng, agent thu scope và liệt kê output cụ thể trước khi tạo artifact.',
        codeSnippet: '// Audit checklist:\n// - locate relevant project files\n// - identify route/options: --creative-brief\n// - confirm output format and save path\n// - avoid unrelated edits',
        icon: '<circle cx=\'11\' cy=\'11\' r=\'8\'/><line x1=\'21\' y1=\'21\' x2=\'16.65\' y2=\'16.65\'/>',
        color: 'green',
        isSubAgent: false
      },
  ...
  // ─── /ckm:dashboard — Dashboard ─────────────────────────────
  {
    ...
    descVi: 'Khởi chạy và quản lý Marketing Dashboard.',
    icon: '<path d="M12 2a10 10 0 0 0-7 17.12"/><path d="M12 2a10 10 0 0 1 7 17.12"/><path d="M2 12h20"/><path d="M12 2c2.5 2.8 4 6.2 4 10s-1.5 7.2-4 10"/><path d="M12 2c-2.5 2.8-4 6.2-4 10s1.5 7.2 4 10"/>',
    accentColor: 'fuchsia',
    steps: [
      {
  ...
  // ─── /ckm:debugging — Debugging ─────────────────────────────
  {
    ...
    descVi: 'Framework debug có hệ thống, tìm nguyên nhân gốc rễ trước khi sửa. Bốn bước debug, truy ngược call stack, xác thực đa lớp. Dùng khi gặp bug, test thất bại, hay hành vi bất thường.',
    icon: '<path d="M12 2a10 10 0 0 0-7 17.12"/><path d="M12 2a10 10 0 0 1 7 17.12"/><path d="M2 12h20"/><path d="M12 2c2.5 2.8 4 6.2 4 10s-1.5 7.2-4 10"/><path d="M12 2c-2.5 2.8-4 6.2-4 10s1.5 7.2 4 10"/>',
    accentColor: 'rose',
    steps: [
      {
  ...
  // ─── /ckm:design-system — Design System ─────────────────────────────
  {
    ...
    descEn: 'Token architecture, component specifications, and slide generation. Three-layer tokens (primitive→semantic→component), CSS variables, spacing/typography scales, component specs, strategic slide creation. Use for design tokens, systematic design, brand-compliant presentations.',
    descVi: 'Kiến trúc token, đặc tả component, và tạo slide. Token 3 lớp (primitive→semantic→component), CSS variables, thang spacing/typography. Dùng cho design token, design có hệ thống, và presentation.',
    icon: '<path d="M12 2a10 10 0 0 0-7 17.12"/><path d="M12 2a10 10 0 0 1 7 17.12"/><path d="M2 12h20"/><path d="M12 2c2.5 2.8 4 6.2 4 10s-1.5 7.2-4 10"/><path d="M12 2c-2.5 2.8-4 6.2-4 10s1.5 7.2 4 10"/>',
    accentColor: 'lime',
    steps: [
      {
  ...
  // ─── /ckm:elevenlabs — Elevenlabs ─────────────────────────────
  {
    ...
    titleEn: 'Elevenlabs',
    titleVi: 'Elevenlabs',
    descEn: 'Generate speech, clone voices, create sound effects & music with ElevenLabs API. TTS, voice design, audio generation, conversational AI agents.',
    descVi: 'Tổng hợp giọng nói, nhân bản giọng, tạo hiệu ứng âm thanh và nhạc với ElevenLabs API. TTS, thiết kế giọng, tạo audio, và AI conversational agent.',
    icon: '<path d="M12 2a10 10 0 0 0-7 17.12"/><path d="M12 2a10 10 0 0 1 7 17.12"/><path d="M2 12h20"/><path d="M12 2c2.5 2.8 4 6.2 4 10s-1.5 7.2-4 10"/><path d="M12 2c-2.5 2.8-4 6.2-4 10s1.5 7.2 4 10"/>',
    accentColor: 'emerald',
    steps: [
      {
  ...
  // ─── /ckm:form-cro — Form CRO ─────────────────────────────
  {
    ...
    descVi: 'Tối ưu form không phải đăng ký — lead capture, liên hệ, demo request, survey, checkout. Dùng khi muốn giảm form friction, tăng tỷ lệ hoàn thành form. Xem signup-flow-cro cho form đăng ký.',
    icon: '<path d="M12 2a10 10 0 0 0-7 17.12"/><path d="M12 2a10 10 0 0 1 7 17.12"/><path d="M2 12h20"/><path d="M12 2c2.5 2.8 4 6.2 4 10s-1.5 7.2-4 10"/><path d="M12 2c-2.5 2.8-4 6.2-4 10s1.5 7.2 4 10"/>',
    accentColor: 'blue',
    steps: [
      {
  ...
  // ─── /ckm:free-tool-strategy — Free Tool Strategy ─────────────────────────────
  {
    ...
    descVi: 'Lập kế hoạch và xây dựng công cụ miễn phí phục vụ marketing — lead generation, SEO, hoặc brand awareness. Cầu nối giữa engineering và marketing, hữu ích cho founder và technical marketer.',
    icon: '<path d="M12 2a10 10 0 0 0-7 17.12"/><path d="M12 2a10 10 0 0 1 7 17.12"/><path d="M2 12h20"/><path d="M12 2c2.5 2.8 4 6.2 4 10s-1.5 7.2-4 10"/><path d="M12 2c-2.5 2.8-4 6.2-4 10s1.5 7.2 4 10"/>',
    accentColor: 'purple',
    steps: [
      {
  ...
  // ─── /ckm:funnel — Funnel ─────────────────────────────
  {
    ...
    descVi: '💡💡 Thiết kế và tối ưu hóa phễu chuyển đổi.',
    icon: '<path d="M12 2a10 10 0 0 0-7 17.12"/><path d="M12 2a10 10 0 0 1 7 17.12"/><path d="M2 12h20"/><path d="M12 2c2.5 2.8 4 6.2 4 10s-1.5 7.2-4 10"/><path d="M12 2c-2.5 2.8-4 6.2-4 10s1.5 7.2 4 10"/>',
    accentColor: 'pink',
    steps: [
      {
  ...
  // ─── /ckm:gamification-marketing — Gamification Marketing ─────────────────────────────
  {
    ...
    descEn: 'Design gamified marketing campaigns using points, badges, leaderboards, streaks, challenges. Use for loyalty programs, referral campaigns, onboarding flows, engagement boosts, email gamification. Provides mechanics selection, psychology alignment, strategy docs, templates, KPIs.',
    descVi: 'Thiết kế chiến dịch gamification với điểm thưởng, huy hiệu, bảng xếp hạng, streak. Dùng cho loyalty program, referral, onboarding, tăng engagement, và email gamification.',
    icon: '<path d="M12 2a10 10 0 0 0-7 17.12"/><path d="M12 2a10 10 0 0 1 7 17.12"/><path d="M2 12h20"/><path d="M12 2c2.5 2.8 4 6.2 4 10s-1.5 7.2-4 10"/><path d="M12 2c-2.5 2.8-4 6.2-4 10s1.5 7.2 4 10"/>',
    accentColor: 'slate',
    steps: [
      {
  ...
  // ─── /ckm:hub — HUB ─────────────────────────────
  {
    ...
    descVi: 'Mở Content Hub và Marketing Dashboard.',
    icon: '<path d="M12 2a10 10 0 0 0-7 17.12"/><path d="M12 2a10 10 0 0 1 7 17.12"/><path d="M2 12h20"/><path d="M12 2c2.5 2.8 4 6.2 4 10s-1.5 7.2-4 10"/><path d="M12 2c-2.5 2.8-4 6.2-4 10s1.5 7.2 4 10"/>',
    accentColor: 'stone',
    steps: [
      {
      ...
      },
      {
        ...
        descEn: 'Read relevant files, docs, inputs, and route options before action',
        descVi: 'Đọc files, docs, input, và route options liên quan trước khi làm',
        explainEn: 'The agent audits the request against local files and the command surface. Important flags or routes are captured before execution: --stop, --scan.\n\nFor broad tasks, it narrows scope and lists the exact output expected before creating artifacts.',
        explainVi: 'Agent audit request với local files và bề mặt command. Flags hoặc routes quan trọng được chốt trước khi chạy: --stop, --scan.\n\nVới task rộng, agent thu scope và liệt kê output cụ thể trước khi tạo artifact.',
        codeSnippet: '// Audit checklist:\n// - locate relevant project files\n// - identify route/options: --stop, --scan\n// - confirm output format and save path\n// - avoid unrelated edits',
        icon: '<circle cx=\'11\' cy=\'11\' r=\'8\'/><line x1=\'21\' y1=\'21\' x2=\'16.65\' y2=\'16.65\'/>',
        color: 'green',
        isSubAgent: false
      },
  ...
  // ─── /ckm:launch-strategy — Launch Strategy ─────────────────────────────
  {
    ...
    descVi: 'When the user wants to plan a product launch, feature announcement, or release strategy. Also use when the user mentions \'launch,\' \'Product Hunt,\' \'feature release,\' \'announcement,\' \'go-to-market,\' \'beta launch,\' \'early access,\' \'waitlist,\' or \'product update.\' This skill covers phased launches, channel strategy, and ongoing launch momentum.',
    icon: '<path d="M12 2a10 10 0 0 0-7 17.12"/><path d="M12 2a10 10 0 0 1 7 17.12"/><path d="M2 12h20"/><path d="M12 2c2.5 2.8 4 6.2 4 10s-1.5 7.2-4 10"/><path d="M12 2c-2.5 2.8-4 6.2-4 10s1.5 7.2 4 10"/>',
    accentColor: 'cyan',
    steps: [
      {
  ...
  // ─── /ckm:logo-design — Logo Design ─────────────────────────────
  {
    ...
    descVi: 'Thiết kế logo với 55 phong cách, 30 bảng màu, 25 ngành. Tạo logo bằng AI. Phong cách: minimalist, vintage, luxury, geometric, mascot. Tích hợp AI prompt, design brief, và tâm lý màu sắc.',
    icon: '<path d="M12 2a10 10 0 0 0-7 17.12"/><path d="M12 2a10 10 0 0 1 7 17.12"/><path d="M2 12h20"/><path d="M12 2c2.5 2.8 4 6.2 4 10s-1.5 7.2-4 10"/><path d="M12 2c-2.5 2.8-4 6.2-4 10s1.5 7.2 4 10"/>',
    accentColor: 'sky',
    steps: [
      {
      ...
      },
      {
        ...
        descEn: 'Read relevant files, docs, inputs, and route options before action',
        descVi: 'Đọc files, docs, input, và route options liên quan trước khi làm',
        explainEn: 'The agent audits the request against local files and the command surface. Important flags or routes are captured before execution: --style, --industry.\n\nFor broad tasks, it narrows scope and lists the exact output expected before creating artifacts.',
        explainVi: 'Agent audit request với local files và bề mặt command. Flags hoặc routes quan trọng được chốt trước khi chạy: --style, --industry.\n\nVới task rộng, agent thu scope và liệt kê output cụ thể trước khi tạo artifact.',
        codeSnippet: '// Audit checklist:\n// - locate relevant project files\n// - identify route/options: --style, --industry\n// - confirm output format and save path\n// - avoid unrelated edits',
        icon: '<circle cx=\'11\' cy=\'11\' r=\'8\'/><line x1=\'21\' y1=\'21\' x2=\'16.65\' y2=\'16.65\'/>',
        color: 'green',
        isSubAgent: false
      },
  ...
  // ─── /ckm:marketing-dashboard — Marketing Dashboard ─────────────────────────────
  {
    ...
    descEn: 'Local-first marketing command center for solopreneurs. Manage campaigns, content, and assets with Claude Code AI automation.',
    descVi: 'Trung tâm marketing local-first cho solopreneur. Quản lý chiến dịch, nội dung và asset với tự động hóa AI từ Claude Code.',
    icon: '<path d="M12 2a10 10 0 0 0-7 17.12"/><path d="M12 2a10 10 0 0 1 7 17.12"/><path d="M2 12h20"/><path d="M12 2c2.5 2.8 4 6.2 4 10s-1.5 7.2-4 10"/><path d="M12 2c-2.5 2.8-4 6.2-4 10s1.5 7.2 4 10"/>',
    accentColor: 'indigo',
    steps: [
      {
  ...
  // ─── /ckm:marketing-planning — Marketing Planning ─────────────────────────────
  {
    ...
    descEn: 'Plan marketing strategies, campaigns, content calendars, and initiatives using proven frameworks (RACE, SOSTAC, STP). Activates marketing-research for data-driven insights.',
    descVi: 'Lập kế hoạch marketing, chiến dịch, lịch nội dung với framework RACE, SOSTAC, STP. Kích hoạt marketing-research để có insight dựa trên dữ liệu.',
    icon: '<path d="M12 2a10 10 0 0 0-7 17.12"/><path d="M12 2a10 10 0 0 1 7 17.12"/><path d="M2 12h20"/><path d="M12 2c2.5 2.8 4 6.2 4 10s-1.5 7.2-4 10"/><path d="M12 2c-2.5 2.8-4 6.2-4 10s1.5 7.2 4 10"/>',
    accentColor: 'fuchsia',
    steps: [
      {
  ...
  // ─── /ckm:marketing-psychology — Marketing Psychology ─────────────────────────────
  {
    ...
    descVi: 'When the user wants to apply psychological principles, mental models, or behavioral science to marketing. Also use when the user mentions \'psychology,\' \'mental models,\' \'cognitive bias,\' \'persuasion,\' \'behavioral science,\' \'why people buy,\' \'decision-making,\' or \'consumer behavior.\' This skill provides 70+ mental models organized for marketing application.',
    icon: '<path d="M12 2a10 10 0 0 0-7 17.12"/><path d="M12 2a10 10 0 0 1 7 17.12"/><path d="M2 12h20"/><path d="M12 2c2.5 2.8 4 6.2 4 10s-1.5 7.2-4 10"/><path d="M12 2c-2.5 2.8-4 6.2-4 10s1.5 7.2 4 10"/>',
    accentColor: 'rose',
    steps: [
      {
  ...
  // ─── /ckm:marketing-research — Marketing Research ─────────────────────────────
  {
    ...
    descEn: 'Research market trends, competitors, audience insights, and marketing best practices. Use before marketing-planning for data-driven strategy.',
    descVi: 'Nghiên cứu xu hướng thị trường, đối thủ, insight khán giả, và best practices marketing. Dùng trước marketing-planning để xây dựng chiến lược dựa trên dữ liệu.',
    icon: '<path d="M12 2a10 10 0 0 0-7 17.12"/><path d="M12 2a10 10 0 0 1 7 17.12"/><path d="M2 12h20"/><path d="M12 2c2.5 2.8 4 6.2 4 10s-1.5 7.2-4 10"/><path d="M12 2c-2.5 2.8-4 6.2-4 10s1.5 7.2 4 10"/>',
    accentColor: 'orange',
    steps: [
      {
  ...
  // ─── /ckm:onboarding-cro — Onboarding CRO ─────────────────────────────
  {
    ...
    descVi: 'Tối ưu onboarding sau đăng ký, user activation, trải nghiệm lần đầu, và time-to-value. Dùng khi cải thiện activation rate, aha moment, hay trải nghiệm người dùng mới.',
    icon: '<path d="M12 2a10 10 0 0 0-7 17.12"/><path d="M12 2a10 10 0 0 1 7 17.12"/><path d="M2 12h20"/><path d="M12 2c2.5 2.8 4 6.2 4 10s-1.5 7.2-4 10"/><path d="M12 2c-2.5 2.8-4 6.2-4 10s1.5 7.2 4 10"/>',
    accentColor: 'lime',
    steps: [
      {
  ...
  // ─── /ckm:paid-ads — Paid ADS ─────────────────────────────
  {
    ...
    descVi: 'When the user wants help with paid advertising campaigns on Google Ads, Meta (Facebook/Instagram), LinkedIn, Twitter/X, or other ad platforms. Also use when the user mentions \'PPC,\' \'paid media,\' \'ad copy,\' \'ad creative,\' \'ROAS,\' \'CPA,\' \'ad campaign,\' \'retargeting,\' or \'audience targeting.\' This skill covers campaign strategy, ad creation, audience targeting, and optimization.',
    icon: '<path d="M12 2a10 10 0 0 0-7 17.12"/><path d="M12 2a10 10 0 0 1 7 17.12"/><path d="M2 12h20"/><path d="M12 2c2.5 2.8 4 6.2 4 10s-1.5 7.2-4 10"/><path d="M12 2c-2.5 2.8-4 6.2-4 10s1.5 7.2 4 10"/>',
    accentColor: 'emerald',
    steps: [
      {
  ...
  // ─── /ckm:play — Play ─────────────────────────────
  {
    ...
    titleVi: 'Play',
    descEn: '>',
    descVi: 'Thử nghiệm và khám phá ý tưởng marketing tự do.',
    icon: '<path d="M12 2a10 10 0 0 0-7 17.12"/><path d="M12 2a10 10 0 0 1 7 17.12"/><path d="M2 12h20"/><path d="M12 2c2.5 2.8 4 6.2 4 10s-1.5 7.2-4 10"/><path d="M12 2c-2.5 2.8-4 6.2-4 10s1.5 7.2 4 10"/>',
    accentColor: 'blue',
    steps: [
      {
  ...
  // ─── /ckm:pricing-strategy — Pricing Strategy ─────────────────────────────
  {
    ...
    descVi: 'When the user wants help with pricing decisions, packaging, or monetization strategy. Also use when the user mentions \'pricing,\' \'pricing tiers,\' \'freemium,\' \'free trial,\' \'packaging,\' \'price increase,\' \'value metric,\' \'Van Westendorp,\' \'willingness to pay,\' or \'monetization.\' This skill covers pricing research, tier structure, and packaging strategy.',
    icon: '<path d="M12 2a10 10 0 0 0-7 17.12"/><path d="M12 2a10 10 0 0 1 7 17.12"/><path d="M2 12h20"/><path d="M12 2c2.5 2.8 4 6.2 4 10s-1.5 7.2-4 10"/><path d="M12 2c-2.5 2.8-4 6.2-4 10s1.5 7.2 4 10"/>',
    accentColor: 'purple',
    steps: [
      {
  ...
  // ─── /ckm:referral-program-building — Referral Program Building ─────────────────────────────
  {
    ...
    descVi: 'Xây dựng chương trình referral cho SaaS/sản phẩm số. Bao gồm cấu trúc thưởng, chọn platform (Rewardful, ReferralCandy), triển khai kỹ thuật, ngăn gian lận, và KPI. Tạo viral growth loop.',
    icon: '<path d="M12 2a10 10 0 0 0-7 17.12"/><path d="M12 2a10 10 0 0 1 7 17.12"/><path d="M2 12h20"/><path d="M12 2c2.5 2.8 4 6.2 4 10s-1.5 7.2-4 10"/><path d="M12 2c-2.5 2.8-4 6.2-4 10s1.5 7.2 4 10"/>',
    accentColor: 'pink',
    steps: [
      {
  ...
  // ─── /ckm:slides — Slides ─────────────────────────────
  {
    ...
    descVi: 'Tạo bài thuyết trình HTML chiến lược với Chart.js, design token, layout responsive, công thức copywriting, và chiến lược slide theo ngữ cảnh.',
    icon: '<path d="M12 2a10 10 0 0 0-7 17.12"/><path d="M12 2a10 10 0 0 1 7 17.12"/><path d="M2 12h20"/><path d="M12 2c2.5 2.8 4 6.2 4 10s-1.5 7.2-4 10"/><path d="M12 2c-2.5 2.8-4 6.2-4 10s1.5 7.2 4 10"/>',
    accentColor: 'stone',
    steps: [
      {
  ...
  // ─── /ckm:storage — Storage ─────────────────────────────
  {
    ...
    descVi: 'Thao tác lưu trữ S3 — upload, đồng bộ, liệt kê, lấy URL.',
    icon: '<path d="M12 2a10 10 0 0 0-7 17.12"/><path d="M12 2a10 10 0 0 1 7 17.12"/><path d="M2 12h20"/><path d="M12 2c2.5 2.8 4 6.2 4 10s-1.5 7.2-4 10"/><path d="M12 2c-2.5 2.8-4 6.2-4 10s1.5 7.2 4 10"/>',
    accentColor: 'teal',
    steps: [
      {
  ...
  // ─── /ckm:youtube — Youtube ─────────────────────────────
  {
    ...
    titleEn: 'Youtube',
    titleVi: 'Youtube',
    descEn: 'Convert YouTube videos to blog posts, infographics, social content. Download video/audio, get captions/transcripts, generate AI summaries, analyze comments via VidCap.xyz API.',
    descVi: 'Chuyển đổi video YouTube thành bài blog, infographic, nội dung mạng xã hội. Tải video/audio, lấy transcript, tạo tóm tắt AI, phân tích bình luận.',
    icon: '<path d="M12 2a10 10 0 0 0-7 17.12"/><path d="M12 2a10 10 0 0 1 7 17.12"/><path d="M2 12h20"/><path d="M12 2c2.5 2.8 4 6.2 4 10s-1.5 7.2-4 10"/><path d="M12 2c-2.5 2.8-4 6.2-4 10s1.5 7.2 4 10"/>',
    accentColor: 'indigo',
    steps: [
      {
  ...
  // ─── /ckm:youtube-thumbnail-design — Youtube Thumbnail Design ─────────────────────────────
  {
    ...
    descVi: 'Thiết kế thumbnail YouTube với 17 phong cách và tối ưu CTR. Tạo thumbnail hoàn chỉnh có chữ bằng AI (render 4K). Hỗ trợ facecam, before-after, listicle, bold-text, và nhiều niche.',
    icon: '<path d="M12 2a10 10 0 0 0-7 17.12"/><path d="M12 2a10 10 0 0 1 7 17.12"/><path d="M2 12h20"/><path d="M12 2c2.5 2.8 4 6.2 4 10s-1.5 7.2-4 10"/><path d="M12 2c-2.5 2.8-4 6.2-4 10s1.5 7.2 4 10"/>',
    accentColor: 'violet',
    steps: [
      {
      ...
      },
      {
        ...
        descEn: 'Read relevant files, docs, inputs, and route options before action',
        descVi: 'Đọc files, docs, input, và route options liên quan trước khi làm',
        explainEn: 'The agent audits the request against local files and the command surface. Important flags or routes are captured before execution: --brand, --brand-colors.\n\nFor broad tasks, it narrows scope and lists the exact output expected before creating artifacts.',
        explainVi: 'Agent audit request với local files và bề mặt command. Flags hoặc routes quan trọng được chốt trước khi chạy: --brand, --brand-colors.\n\nVới task rộng, agent thu scope và liệt kê output cụ thể trước khi tạo artifact.',
        codeSnippet: '// Audit checklist:\n// - locate relevant project files\n// - identify route/options: --brand, --brand-colors\n// - confirm output format and save path\n// - avoid unrelated edits',
        icon: '<circle cx=\'11\' cy=\'11\' r=\'8\'/><line x1=\'21\' y1=\'21\' x2=\'16.65\' y2=\'16.65\'/>',
        color: 'green',
        isSubAgent: false
      },
  ...
  // ─── /ckm:ask — ASK Commands ─────────────────────────────
  {
    ...
    descVi: '💡 Giải đáp câu hỏi kỹ thuật và kiến trúc.',
    icon: '<path d="M12 2a10 10 0 0 0-7 17.12"/><path d="M12 2a10 10 0 0 1 7 17.12"/><path d="M2 12h20"/><path d="M12 2c2.5 2.8 4 6.2 4 10s-1.5 7.2-4 10"/><path d="M12 2c-2.5 2.8-4 6.2-4 10s1.5 7.2 4 10"/>',
    accentColor: 'orange',
    steps: [
      {
  ...
  // ─── /ckm:docs:* — Docs Commands ─────────────────────────────
  {
    ...
    steps: [
      ...
      },
      {
        ...
        descEn: 'Read relevant files, docs, inputs, and route options before action',
        descVi: 'Đọc files, docs, input, và route options liên quan trước khi làm',
        explainEn: 'The agent audits the request against local files and the command surface. Important flags or routes are captured before execution: :init, :llms, :summarize, :update.\n\nFor broad tasks, it narrows scope and lists the exact output expected before creating artifacts.',
        explainVi: 'Agent audit request với local files và bề mặt command. Flags hoặc routes quan trọng được chốt trước khi chạy: :init, :llms, :summarize, :update.\n\nVới task rộng, agent thu scope và liệt kê output cụ thể trước khi tạo artifact.',
        codeSnippet: '// Audit checklist:\n// - locate relevant project files\n// - identify route/options: :init, :llms, :summarize, :update\n// - confirm output format and save path\n// - avoid unrelated edits',
        icon: '<circle cx=\'11\' cy=\'11\' r=\'8\'/><line x1=\'21\' y1=\'21\' x2=\'16.65\' y2=\'16.65\'/>',
        color: 'green',
        isSubAgent: false
      },
  ...
  // ─── /ckm:journal — Journal Commands ─────────────────────────────
  {
    ...
    descEn: '💡 Write some journal entries.',
    descVi: '💡 Viết journal ghi lại các quyết định và bài học.',
    icon: '<path d="M12 2a10 10 0 0 0-7 17.12"/><path d="M12 2a10 10 0 0 1 7 17.12"/><path d="M2 12h20"/><path d="M12 2c2.5 2.8 4 6.2 4 10s-1.5 7.2-4 10"/><path d="M12 2c-2.5 2.8-4 6.2-4 10s1.5 7.2 4 10"/>',
    accentColor: 'teal',
    steps: [
      {
  ...
  // ─── /ckm:kanban — Kanban Commands ─────────────────────────────
  {
    ...
    descVi: 'Bảng điều phối AI agent (Sắp ra mắt).',
    icon: '<path d="M12 2a10 10 0 0 0-7 17.12"/><path d="M12 2a10 10 0 0 1 7 17.12"/><path d="M2 12h20"/><path d="M12 2c2.5 2.8 4 6.2 4 10s-1.5 7.2-4 10"/><path d="M12 2c-2.5 2.8-4 6.2-4 10s1.5 7.2 4 10"/>',
    accentColor: 'cyan',
    steps: [
      {
  ...
  // ─── /ckm:plan:* — Plan Commands ─────────────────────────────
  {
    ...
    descVi: '💡💡💡 Tạo plan thông minh với tăng cường prompt.',
    icon: '<path d="M12 2a10 10 0 0 0-7 17.12"/><path d="M12 2a10 10 0 0 1 7 17.12"/><path d="M2 12h20"/><path d="M12 2c2.5 2.8 4 6.2 4 10s-1.5 7.2-4 10"/><path d="M12 2c-2.5 2.8-4 6.2-4 10s1.5 7.2 4 10"/>',
    accentColor: 'indigo',
    steps: [
      {
      ...
      },
      {
        ...
        descEn: 'Read relevant files, docs, inputs, and route options before action',
        descVi: 'Đọc files, docs, input, và route options liên quan trước khi làm',
        explainEn: 'The agent audits the request against local files and the command surface. Important flags or routes are captured before execution: :archive, :ci, :cro, :fast, :hard, :parallel, :two, :validate.\n\nFor broad tasks, it narrows scope and lists the exact output expected before creating artifacts.',
        explainVi: 'Agent audit request với local files và bề mặt command. Flags hoặc routes quan trọng được chốt trước khi chạy: :archive, :ci, :cro, :fast, :hard, :parallel, :two, :validate.\n\nVới task rộng, agent thu scope và liệt kê output cụ thể trước khi tạo artifact.',
        codeSnippet: '// Audit checklist:\n// - locate relevant project files\n// - identify route/options: :archive, :ci, :cro, :fast, :hard, :parallel, :two, :validate\n// - confirm output format and save path\n// - avoid unrelated edits',
        icon: '<circle cx=\'11\' cy=\'11\' r=\'8\'/><line x1=\'21\' y1=\'21\' x2=\'16.65\' y2=\'16.65\'/>',
        color: 'green',
        isSubAgent: false
      },
  ...
  // ─── /ckm:preview — Preview Commands ─────────────────────────────
  {
    ...
    descVi: 'Xem trước file markdown, thư mục plan, hoặc tập hợp plans.',
    icon: '<path d="M12 2a10 10 0 0 0-7 17.12"/><path d="M12 2a10 10 0 0 1 7 17.12"/><path d="M2 12h20"/><path d="M12 2c2.5 2.8 4 6.2 4 10s-1.5 7.2-4 10"/><path d="M12 2c-2.5 2.8-4 6.2-4 10s1.5 7.2 4 10"/>',
    accentColor: 'fuchsia',
    steps: [
      {
  ...
  // ─── /ckm:skill:* — Skill Commands ─────────────────────────────
  {
    ...
    steps: [
      ...
      },
      {
        ...
        descEn: 'Read relevant files, docs, inputs, and route options before action',
        descVi: 'Đọc files, docs, input, và route options liên quan trước khi làm',
        explainEn: 'The agent audits the request against local files and the command surface. Important flags or routes are captured before execution: :add, :create, :fix-logs, :optimize, :optimize:auto, :plan, :update.\n\nFor broad tasks, it narrows scope and lists the exact output expected before creating artifacts.',
        explainVi: 'Agent audit request với local files và bề mặt command. Flags hoặc routes quan trọng được chốt trước khi chạy: :add, :create, :fix-logs, :optimize, :optimize:auto, :plan, :update.\n\nVới task rộng, agent thu scope và liệt kê output cụ thể trước khi tạo artifact.',
        codeSnippet: '// Audit checklist:\n// - locate relevant project files\n// - identify route/options: :add, :create, :fix-logs, :optimize, :optimize:auto, :plan, :update\n// - confirm output format and save path\n// - avoid unrelated edits',
        icon: '<circle cx=\'11\' cy=\'11\' r=\'8\'/><line x1=\'21\' y1=\'21\' x2=\'16.65\' y2=\'16.65\'/>',
        color: 'green',
        isSubAgent: false
      },
  ...
  // ─── /ckm:test:* — Test Commands ─────────────────────────────
  {
    ...
    steps: [
      ...
      },
      {
        ...
        descEn: 'Read relevant files, docs, inputs, and route options before action',
        descVi: 'Đọc files, docs, input, và route options liên quan trước khi làm',
        explainEn: 'The agent audits the request against local files and the command surface. Important flags or routes are captured before execution: :ui, :workflow.\n\nFor broad tasks, it narrows scope and lists the exact output expected before creating artifacts.',
        explainVi: 'Agent audit request với local files và bề mặt command. Flags hoặc routes quan trọng được chốt trước khi chạy: :ui, :workflow.\n\nVới task rộng, agent thu scope và liệt kê output cụ thể trước khi tạo artifact.',
        codeSnippet: '// Audit checklist:\n// - locate relevant project files\n// - identify route/options: :ui, :workflow\n// - confirm output format and save path\n// - avoid unrelated edits',
        icon: '<circle cx=\'11\' cy=\'11\' r=\'8\'/><line x1=\'21\' y1=\'21\' x2=\'16.65\' y2=\'16.65\'/>',
        color: 'green',
        isSubAgent: false
      },
