...
export const workflowScenarios: WorkflowScenario[] = [
  ...
  // ─── /ck:cook — Build Feature ────────────────────────────────
  {
    ...
    descEn: '6-step implementation with review gates',
    descVi: 'Pipeline 6 bước triển khai với review gates',
  ...
  // ─── /ck:fix — Fix a Bug ─────────────────────────────────────
  {
    ...
    titleEn: 'Fix a Bug',
    titleVi: 'Sửa Lỗi',
    descEn: 'Standard 6-phase bug diagnosis and repair pipeline',
    descVi: 'Quy trình chuẩn 6 phase chẩn đoán và sửa lỗi',
    icon: '<path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/>',
    accentColor: 'red',
    steps: [
  ...
  // ─── /ck:code-review — Adversarial Code Review ──────────────
  {
    ...
    titleEn: 'Code Review',
    titleVi: 'Review Code',
    descEn: 'Adversarial 3-stage review with red-team analysis on every review',
    descVi: 'Review đối kháng 3 giai đoạn với red-team analysis trên mọi review',
  ...
  // ─── /ck:deploy — Auto-Detect Deploy Pipeline ────────────────
  {
    ...
    steps: [
      ...
      },
      {
        ...
        descEn: '4-step detection cascade, cost-optimized recommendation',
        descVi: 'Detection cascade 4 bước, đề xuất tối ưu chi phí',
