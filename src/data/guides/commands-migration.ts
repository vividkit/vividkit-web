...
export const marketingMigrationExtra: MigrationRow[] = [
  ...
  { old: '/mkt:video:script', new: '/ckm:video:script:create [topic]', prefixType: 'purple' },
  ...
  { old: '/mkt:plan:validate', new: '/ckm:plan:validate [plan]', prefixType: 'purple' },
  { old: '/mkt:write:formula [type]', new: '/ckm:write:formula [type]', prefixType: 'purple' },
  { old: '/mkt:video:storyboard', new: '/ckm:video:storyboard:create [topic]', prefixType: 'purple' },
  ...
  { old: '/mkt:plan:ci', new: '/ckm:plan:ci [url]', prefixType: 'purple' },
  { old: '/mkt:ck-help', new: 'Removed; use skill discovery', prefixType: 'purple' },
  ...
  { old: '/mkt:test:ui', new: '/ckm:test:ui [url]', prefixType: 'purple' },
  { old: '/mkt:test:workflow', new: '/ckm:test:workflow [name]', prefixType: 'purple' },
];
