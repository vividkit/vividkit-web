...
//   via appends; marketing appends.skills adds its own skills and inherits core.
...
export const akEngineerSkills: AkSkillEntry[] = [
  ...
  },
  {
    ...
    description: "Create a portable, redacted Markdown continuation contract for a fresh coding agent, and optionally dispatch it to one selected runtime with --dispatch. Use when switching sessions, models, or runtimes. Not a human status report (use /ak:watzup) and not a multi-job graph (use /ak:orchestrate).",
    descriptionVi: "Tạo hợp đồng Markdown đã redact để agent coding mới tiếp tục, và có thể giao cho đúng một runtime đã chọn bằng --dispatch. Dùng khi đổi phiên, model hoặc runtime. Không phải báo cáo cho người (dùng /ak:watzup) và không phải đồ thị nhiều việc (dùng /ak:orchestrate).",
    category: "sessionMgmt",
  ...
  },
  {
    ...
    description: "Wrap HeyGen HyperFrames CLI for HTML-first programmatic video. Use for short vertical/social clips, product-launch loops, and motion graphics whose source is HTML composition (not React/Remotion). Local preview + lint, optional HeyGen cloud render. nexu-io/html-video is an in-skill alternative only when that binary or a matching template catalog is already available.",
    descriptionVi: "Bọc CLI HeyGen HyperFrames để dựng video theo chương trình, lấy HTML làm nguồn. Dùng khi làm clip dọc/mạng xã hội ngắn, vòng lặp ra mắt sản phẩm, hoặc motion graphic từ HTML (không phải React/Remotion); xem trước và lint ngay máy, render đám mây HeyGen nếu muốn. nexu-io/html-video chỉ là lối thay thế trong skill khi máy đã có binary đó hoặc catalog mẫu khớp.",
    category: "aiMultimodal",
  ...
  },
  {
    ...
    description: "Coordinate staged or parallel jobs across live-verified coding-agent runtimes, Pi coding-agent sessions, and in-session subagents, using capability- and risk-based routing, worktree-isolated writes, resumable state, capture, safety gates, and independent arbiter review. A missing Pi runtime is onboarded as a visible setup step when a job asks for Pi.",
    descriptionVi: "Điều phối việc theo giai đoạn hoặc song song trên runtime agent lập trình đã xác thực, phiên Pi, và subagent trong phiên: chọn theo năng lực và rủi ro, ghi tách worktree, trạng thái nối lại được, ghi lại, cổng an toàn, và rà soát arbiter độc lập. Pi chưa cài được thiết lập thành bước hiện, khi job yêu cầu Pi.",
    category: "sessionMgmt",
    isNew: true,
  ...
  },
  {
    ...
    description: "UI/UX design intelligence for web and mobile: style selection, color systems, typography, layout, accessibility, interaction states, responsive behavior, forms, charts, design systems, code review, and a UI/UX guideline review of existing interface code across React, Next.js, Vue, Svelte, SwiftUI, React Native, Flutter, Tailwind, shadcn/ui, and HTML/CSS.",
    descriptionVi: "Tư vấn thiết kế UI/UX cho web và mobile: chọn style, hệ màu, chữ, layout, accessibility, trạng thái tương tác, hành vi responsive, form, chart, design system, rà soát mã, và rà guideline UI/UX trên mã giao diện sẵn có của React, Next.js, Vue, Svelte, SwiftUI, React Native, Flutter, Tailwind, shadcn/ui và HTML/CSS.",
    category: "designFrontend",
...
export const akMarketingSkills: AkSkillEntry[] = [
  ...
  },
  {
    ...
    description: "Marketing playbook orchestrator with dependency-graph routing, quality gates, goal tracking, and smart suggestions. Expert strategy × AI execution speed. Includes the founder and product-owner product-discovery template. Triggers: /ak:play, playbook, campaign playbook, product discovery, what's next, play status.",
    descriptionVi: "Điều phối playbook marketing: đưa việc theo đồ thị phụ thuộc, qua cổng chất lượng, theo dõi mục tiêu và gợi ý thông minh, kết hợp chiến lược chuyên gia với tốc độ thực thi AI. Có template product-discovery cho founder và product owner. Dùng khi gọi /ak:play, playbook, campaign playbook, product discovery, what's next hoặc play status.",
    category: "contentCopy",
