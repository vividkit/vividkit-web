...
| `AK-RELEASE-BETA-2.5.0-BETA.1` | active beta | `2.5.0-beta.1` | `2026-07-21T16:45:43Z`, HTTPS GET, no redirects, reviewed | [changelog](https://agentkit.best/changelog) | `1fd29521a914a7ae1c5021fa53fa154dee0c394a4137f39a1ba3ff4f24ef305d` | `4297c3803c1af714beeb51a193118830b28a8797d078e4797a69a9f9d32a544d` |
| `AK-RELEASE-PRERELEASE-2.4.0-BETA.7` | historical prerelease provenance | `2.4.0-beta.7` | `2026-07-20T08:09:38Z`, HTTPS GET, no redirects, reviewed | [signed beta catalog](https://releases.agentkit.best/channels/beta/release-catalog.json) | `6a1bbdff9a54e5e3dd106c2e9d4057876a4194cce78ddc113ce30e04df5c5097` | `075a4fd1d8c024eba1ce4e550e8bdf88bb61f769e923e54755aa47f910cfea44` |
...
Both current catalogs identify source commit `c8183754418b8bfd7be56155081394f85a340edb` for stable `2.4.0`. The 2026-07-21 changelog observation shows active public beta `2.5.0-beta.1` (source commit `5aa43d2e8838cc6cd79749c46a5bd03129448eed`). Historical `2.4.0-beta.7` remains promotion provenance for stable and is no longer the current beta pointer. `hasActiveBeta` is true. Exact-tag evidence for stable remains from `v2.4.0`: `INSTALL.md` SHA-256 `a923544591a3dfdeeb0528492e228ace662bc44cf22e968ea30e777aa506bbf7`, 120-path parity manifest `198c9e4957b8f445496ed3714901a599f45c84667fdb0a6bb1a3f3c6b4e88c4c`, command tree `b52eb55bfaf508ae362771f67858d9191b3a5d35e4ec13917f4206e12f394baf`, runtime matrix YAML `fbe63f9d50904c56884a7fbf33e5aa0d26834bc7c2d4ddbfa1cbecae29646d85`, and generated Markdown `95ce4b8cf00e5aeca72b3d4fb76d13064b4640f2864f218bfa7764d0c97ea139`.

The bounded online changelog canary for the 2026-07-21 sync expects stable `2.4.0` and prerelease `2.5.0-beta.1`. Current release cards include older version strings inside provenance copy, so the fail-closed parser continues to bind each version to its exact release heading.
