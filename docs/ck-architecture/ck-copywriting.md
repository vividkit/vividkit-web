...
Source: `reference/marketing-stable/claude/skills/copywriting/SKILL.md`

## Authoritative Flow

1. Invoke /ck:copywriting with a concrete target, constraints, and expected output.
