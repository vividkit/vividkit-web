...
Source: `reference/marketing-stable/claude/skills/ui-styling/SKILL.md`

## Authoritative Flow

1. Invoke /ck:ui-styling with a concrete target, constraints, and expected output.
