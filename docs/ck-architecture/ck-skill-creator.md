...
Source: `reference/marketing-stable/claude/skills/skill-creator/SKILL.md`

## Authoritative Flow

1. Invoke /ck:skill-creator with a concrete target, constraints, and expected output.
