...
Source: `reference/marketing-stable/claude/commands/ckm/journal.md`

## Authoritative Flow

1. Invoke /ckm:journal with a concrete target, constraints, and expected output.
