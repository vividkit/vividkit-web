...
Source: `reference/marketing-stable/claude/commands/ckm/kanban.md`

## Authoritative Flow

1. Invoke /ckm:kanban with a concrete target, constraints, and expected output.
