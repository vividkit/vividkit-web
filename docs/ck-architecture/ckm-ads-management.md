...
Source: `reference/marketing-stable/claude/skills/ads-management/SKILL.md`

## Authoritative Flow

1. Invoke /ckm:ads-management with a concrete target, constraints, and expected output.
