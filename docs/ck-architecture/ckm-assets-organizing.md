...
Source: `reference/marketing-stable/claude/skills/assets-organizing/SKILL.md`

## Authoritative Flow

1. Invoke /ckm:assets-organizing with a concrete target, constraints, and expected output.
...
| Type | Skill |
|------|-------|
| Mandatory | ckm:assets-organizing |
