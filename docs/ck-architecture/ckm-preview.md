...
Source: `reference/marketing-stable/claude/commands/ckm/preview.md`

## Authoritative Flow

1. Invoke /ckm:preview with a concrete target, constraints, and expected output.
