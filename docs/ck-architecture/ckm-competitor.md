...
Source: `reference/marketing-stable/claude/skills/competitor/SKILL.md`

## Authoritative Flow

1. Invoke /ckm:competitor with a concrete target, constraints, and expected output.
