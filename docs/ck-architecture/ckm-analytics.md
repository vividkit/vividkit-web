...
Source: `reference/marketing-stable/claude/skills/analytics/SKILL.md`

## Authoritative Flow

1. Invoke /ckm:analytics with a concrete target, constraints, and expected output.
