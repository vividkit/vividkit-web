...
Source: `reference/marketing-stable/claude/skills/remotion/SKILL.md`

## Authoritative Flow

1. Invoke /ck:remotion with a concrete target, constraints, and expected output.
