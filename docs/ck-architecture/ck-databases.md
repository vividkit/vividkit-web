...
Source: `reference/marketing-stable/claude/skills/databases/SKILL.md`

## Authoritative Flow

1. Invoke /ck:databases with a concrete target, constraints, and expected output.
