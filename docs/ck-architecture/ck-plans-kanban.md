...
Source: `reference/marketing-stable/claude/skills/plans-kanban/SKILL.md`

## Authoritative Flow

1. Invoke /ck:plans-kanban with a concrete target, constraints, and expected output.
