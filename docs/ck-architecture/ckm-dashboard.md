...
Source: `reference/marketing-stable/claude/skills/dashboard/SKILL.md`

## Authoritative Flow

1. Invoke /ckm:dashboard with a concrete target, constraints, and expected output.
