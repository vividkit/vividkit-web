...
Source: `reference/stable/claude/skills/show-off/SKILL.md`

## Authoritative Flow

1. Invoke /ck:show-off with a concrete target, constraints, and expected output.
...
Supported route markers: --settle-delay, --delay, --url, --output-dir, --sections, --ratios, --render-timeout, --format.
