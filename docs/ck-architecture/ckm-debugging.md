...
Source: `reference/marketing-stable/claude/skills/debugging/SKILL.md`

## Authoritative Flow

1. Invoke /ckm:debugging with a concrete target, constraints, and expected output.
