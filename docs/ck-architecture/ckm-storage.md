...
Source: `reference/marketing-stable/claude/skills/ckm-storage/SKILL.md`

## Authoritative Flow

1. Invoke /ckm:storage with a concrete target, constraints, and expected output.
