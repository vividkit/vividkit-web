...
Source: `reference/marketing-stable/claude/skills/ab-test-setup/SKILL.md`

## Authoritative Flow

1. Invoke /ckm:ab-test-setup with a concrete target, constraints, and expected output.
