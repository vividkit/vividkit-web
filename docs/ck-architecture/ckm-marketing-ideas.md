...
Source: `reference/marketing-stable/claude/skills/marketing-ideas/SKILL.md`

## Authoritative Flow

1. Invoke /ckm:marketing-ideas with a concrete target, constraints, and expected output.
