...
Source: `reference/marketing-stable/claude/commands/ckm/plan.md`

## Authoritative Flow

1. Invoke /ckm:plan:* with a concrete target, constraints, and expected output.
...
Supported route markers: :archive, :ci, :cro, :fast, :hard, :parallel, :two, :validate.
