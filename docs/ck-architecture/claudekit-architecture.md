...
- [ck-code-review.md](ck-code-review.md) — /ck:code-review adversarial 3-stage review with red-team analysis
...
- [ckm-campaign.md](ckm-campaign.md) — /ckm:campaign:* campaign management (create, status, analyze, email)
- [ckm-social.md](ckm-social.md) — /ckm:social:* social media content across 7 platforms
- [ckm-email.md](ckm-email.md) — /ckm:email:* email campaigns, automation flows, drip sequences
- [ckm-persona.md](ckm-persona.md) — /ckm:persona customer persona with market-validated ICP
- [ckm-video.md](ckm-video.md) — /ckm:video:* AI video production (Veo 3.1, FFmpeg, multi-platform)
