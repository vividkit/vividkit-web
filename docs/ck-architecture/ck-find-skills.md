...
Source: `reference/stable/.agents/skills/find-skills/SKILL.md`

## Authoritative Flow

1. Invoke /ck:find-skills with a concrete target, constraints, and expected output.
