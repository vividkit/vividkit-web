...
Source: `reference/marketing-stable/claude/skills/journal/SKILL.md`

## Authoritative Flow

1. Invoke /ck:journal with a concrete target, constraints, and expected output.
