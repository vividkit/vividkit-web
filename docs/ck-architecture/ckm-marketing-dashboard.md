...
Source: `reference/marketing-stable/claude/skills/marketing-dashboard/SKILL.md`

## Authoritative Flow

1. Invoke /ckm:marketing-dashboard with a concrete target, constraints, and expected output.
...
| Type | Skill |
|------|-------|
| Mandatory | ckm:marketing-dashboard |
