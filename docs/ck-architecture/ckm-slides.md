...
Source: `reference/marketing-stable/claude/skills/slides/SKILL.md`

## Authoritative Flow

1. Invoke /ckm:slides with a concrete target, constraints, and expected output.
