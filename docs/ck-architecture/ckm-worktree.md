...
Source: `reference/marketing-stable/claude/commands/ckm/worktree.md`

## Authoritative Flow

1. Invoke /ckm:worktree with a concrete target, constraints, and expected output.
