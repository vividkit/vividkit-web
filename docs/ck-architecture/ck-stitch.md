...
Source: `reference/stable/claude/skills/stitch/SKILL.md`

## Authoritative Flow

1. Invoke /ck:stitch with a concrete target, constraints, and expected output.
...
Supported route markers: --variants, --project-name.
