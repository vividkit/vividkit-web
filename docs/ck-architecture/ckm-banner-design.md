...
Source: `reference/marketing-stable/claude/skills/banner-design/SKILL.md`

## Authoritative Flow

1. Invoke /ckm:banner-design with a concrete target, constraints, and expected output.
