...
Source: `reference/stable/claude/skills/project-organization/SKILL.md`

## Authoritative Flow

1. Invoke /ck:project-organization with a concrete target, constraints, and expected output.
