...
Source: `reference/marketing-stable/claude/skills/creativity/SKILL.md`

## Authoritative Flow

1. Invoke /ckm:creativity with a concrete target, constraints, and expected output.
...
Supported route markers: --creative-brief.
