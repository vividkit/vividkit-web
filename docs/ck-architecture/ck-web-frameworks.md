...
Source: `reference/marketing-stable/claude/skills/web-frameworks/SKILL.md`

## Authoritative Flow

1. Invoke /ck:web-frameworks with a concrete target, constraints, and expected output.
