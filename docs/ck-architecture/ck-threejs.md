...
Source: `reference/marketing-stable/claude/skills/threejs/SKILL.md`

## Authoritative Flow

1. Invoke /ck:threejs with a concrete target, constraints, and expected output.
