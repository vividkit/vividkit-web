...
Source: `reference/marketing-stable/claude/skills/claude-code/SKILL.md`

## Authoritative Flow

1. Invoke /ckm:claude-code with a concrete target, constraints, and expected output.
