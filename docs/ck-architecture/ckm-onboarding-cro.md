...
Source: `reference/marketing-stable/claude/skills/onboarding-cro/SKILL.md`

## Authoritative Flow

1. Invoke /ckm:onboarding-cro with a concrete target, constraints, and expected output.
