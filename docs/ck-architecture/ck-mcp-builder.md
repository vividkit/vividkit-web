...
Source: `reference/marketing-stable/claude/skills/mcp-builder/SKILL.md`

## Authoritative Flow

1. Invoke /ck:mcp-builder with a concrete target, constraints, and expected output.
