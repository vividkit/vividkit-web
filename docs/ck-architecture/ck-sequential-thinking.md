...
Source: `reference/marketing-stable/claude/skills/sequential-thinking/SKILL.md`

## Authoritative Flow

1. Invoke /ck:sequential-thinking with a concrete target, constraints, and expected output.
...
| Type | Skill |
|------|-------|
| Mandatory | ck:sequential-thinking |
