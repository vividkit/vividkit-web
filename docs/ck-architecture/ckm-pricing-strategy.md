...
Source: `reference/marketing-stable/claude/skills/pricing-strategy/SKILL.md`

## Authoritative Flow

1. Invoke /ckm:pricing-strategy with a concrete target, constraints, and expected output.
...
| Type | Skill |
|------|-------|
| Mandatory | ckm:pricing-strategy |
