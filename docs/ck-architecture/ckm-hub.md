...
Source: `reference/marketing-stable/claude/skills/hub/SKILL.md`

## Authoritative Flow

1. Invoke /ckm:hub with a concrete target, constraints, and expected output.
...
Supported route markers: --stop, --scan.
