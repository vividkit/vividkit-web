...
Source: `reference/marketing-stable/claude/skills/problem-solving/SKILL.md`

## Authoritative Flow

1. Invoke /ck:problem-solving with a concrete target, constraints, and expected output.
