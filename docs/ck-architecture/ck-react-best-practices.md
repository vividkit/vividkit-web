...
Source: `reference/stable/claude/skills/react-best-practices/SKILL.md`

## Authoritative Flow

1. Invoke /ck:react-best-practices with a concrete target, constraints, and expected output.
...
| Type | Skill |
|------|-------|
| Mandatory | ck:react-best-practices |
