...
Source: `reference/marketing-stable/claude/skills/content-marketing/SKILL.md`

## Authoritative Flow

1. Invoke /ckm:content-marketing with a concrete target, constraints, and expected output.
...
| Type | Skill |
|------|-------|
| Mandatory | ckm:content-marketing |
