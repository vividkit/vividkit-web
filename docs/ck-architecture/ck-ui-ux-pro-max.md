...
Source: `reference/marketing-stable/claude/skills/ui-ux-pro-max/SKILL.md`

## Authoritative Flow

1. Invoke /ck:ui-ux-pro-max with a concrete target, constraints, and expected output.
...
Supported route markers: --design-system, --persist, --domain.
