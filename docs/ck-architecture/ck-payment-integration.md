...
Source: `reference/marketing-stable/claude/skills/payment-integration/SKILL.md`

## Authoritative Flow

1. Invoke /ck:payment-integration with a concrete target, constraints, and expected output.
...
| Type | Skill |
|------|-------|
| Mandatory | ck:payment-integration |
