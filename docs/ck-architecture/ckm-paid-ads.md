...
Source: `reference/marketing-stable/claude/skills/paid-ads/SKILL.md`

## Authoritative Flow

1. Invoke /ckm:paid-ads with a concrete target, constraints, and expected output.
