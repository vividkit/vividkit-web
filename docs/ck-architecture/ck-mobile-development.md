...
Source: `reference/stable/claude/skills/mobile-development/SKILL.md`

## Authoritative Flow

1. Invoke /ck:mobile-development with a concrete target, constraints, and expected output.
...
| Type | Skill |
|------|-------|
| Mandatory | ck:mobile-development |
