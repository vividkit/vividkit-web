...
Source: `reference/marketing-stable/claude/skills/worktree/SKILL.md`

## Authoritative Flow

1. Invoke /ck:worktree with a concrete target, constraints, and expected output.
...
Supported route markers: --prefix, --env, --json, --dry-run.
