...
Source: `reference/marketing-stable/claude/skills/media-processing/SKILL.md`

## Authoritative Flow

1. Invoke /ck:media-processing with a concrete target, constraints, and expected output.
