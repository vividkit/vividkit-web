...
Source: `reference/stable/claude/skills/web-testing/SKILL.md`

## Authoritative Flow

1. Invoke /ck:web-testing with a concrete target, constraints, and expected output.
