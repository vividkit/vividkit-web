...
Source: `reference/stable/claude/skills/research/SKILL.md`

## Authoritative Flow

1. Invoke /ck:research with a concrete target, constraints, and expected output.
