...
Source: `reference/marketing-stable/claude/skills/logo-design/SKILL.md`

## Authoritative Flow

1. Invoke /ckm:logo-design with a concrete target, constraints, and expected output.
...
Supported route markers: --style, --industry.
