...
Source: `reference/marketing-stable/claude/skills/mermaidjs-v11/SKILL.md`

## Authoritative Flow

1. Invoke /ck:mermaidjs-v11 with a concrete target, constraints, and expected output.
