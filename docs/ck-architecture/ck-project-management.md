...
Source: `reference/stable/claude/skills/project-management/SKILL.md`

## Authoritative Flow

1. Invoke /ck:project-management with a concrete target, constraints, and expected output.
...
| Type | Skill |
|------|-------|
| Mandatory | ck:project-management |
