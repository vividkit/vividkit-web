...
1. Invoke /ckm:skill:* with a concrete target, constraints, and expected output.
...
Supported route markers: :add, :create, :fix-logs, :optimize, :optimize:auto, :plan, :update.
