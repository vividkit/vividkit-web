...
Source: `reference/marketing-stable/claude/skills/design-system/SKILL.md`

## Authoritative Flow

1. Invoke /ckm:design-system with a concrete target, constraints, and expected output.
