...
Source: `reference/marketing-stable/claude/skills/frontend-development/SKILL.md`

## Authoritative Flow

1. Invoke /ck:frontend-development with a concrete target, constraints, and expected output.
...
| Type | Skill |
|------|-------|
| Mandatory | ck:frontend-development |
