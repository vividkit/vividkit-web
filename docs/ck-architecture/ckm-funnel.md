...
Source: `reference/marketing-stable/claude/skills/funnel/SKILL.md`

## Authoritative Flow

1. Invoke /ckm:funnel with a concrete target, constraints, and expected output.
