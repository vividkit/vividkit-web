...
Source: `reference/marketing-stable/claude/skills/launch-strategy/SKILL.md`

## Authoritative Flow

1. Invoke /ckm:launch-strategy with a concrete target, constraints, and expected output.
