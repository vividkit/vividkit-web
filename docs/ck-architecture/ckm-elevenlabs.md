...
Source: `reference/marketing-stable/claude/skills/elevenlabs/SKILL.md`

## Authoritative Flow

1. Invoke /ckm:elevenlabs with a concrete target, constraints, and expected output.
