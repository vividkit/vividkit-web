...
Source: `reference/marketing-stable/claude/skills/form-cro/SKILL.md`

## Authoritative Flow

1. Invoke /ckm:form-cro with a concrete target, constraints, and expected output.
