...
Source: `reference/marketing-stable/claude/skills/referral-program-building/SKILL.md`

## Authoritative Flow

1. Invoke /ckm:referral-program-building with a concrete target, constraints, and expected output.
...
| Type | Skill |
|------|-------|
| Mandatory | ckm:referral-program-building |
