...
Source: `reference/marketing-stable/claude/skills/cip-design/SKILL.md`

## Authoritative Flow

1. Invoke /ckm:cip-design with a concrete target, constraints, and expected output.
