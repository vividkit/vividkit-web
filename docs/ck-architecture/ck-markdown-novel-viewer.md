...
Source: `reference/marketing-stable/claude/skills/markdown-novel-viewer/SKILL.md`

## Authoritative Flow

1. Invoke /ck:markdown-novel-viewer with a concrete target, constraints, and expected output.
...
| Type | Skill |
|------|-------|
| Mandatory | ck:markdown-novel-viewer |
...
Supported route markers: --open, --background, --stop.
