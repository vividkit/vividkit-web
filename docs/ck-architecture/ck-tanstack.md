...
Source: `reference/stable/claude/skills/tanstack/SKILL.md`

## Authoritative Flow

1. Invoke /ck:tanstack with a concrete target, constraints, and expected output.
