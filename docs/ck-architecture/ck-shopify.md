...
Source: `reference/marketing-stable/claude/skills/shopify/SKILL.md`

## Authoritative Flow

1. Invoke /ck:shopify with a concrete target, constraints, and expected output.
