...
Source: `reference/marketing-stable/claude/skills/youtube/SKILL.md`

## Authoritative Flow

1. Invoke /ckm:youtube with a concrete target, constraints, and expected output.
