...
Source: `reference/marketing-stable/claude/skills/content-hub/SKILL.md`

## Authoritative Flow

1. Invoke /ckm:content-hub with a concrete target, constraints, and expected output.
