...
Source: `reference/stable/claude/skills/coding-level/SKILL.md`

## Authoritative Flow

1. Invoke /ck:coding-level with a concrete target, constraints, and expected output.
