...
Source: `reference/marketing-stable/claude/skills/kit-builder/SKILL.md`

## Authoritative Flow

1. Invoke /ckm:kit-builder with a concrete target, constraints, and expected output.
