...
Source: `reference/marketing-stable/claude/skills/google-adk-python/SKILL.md`

## Authoritative Flow

1. Invoke /ck:google-adk-python with a concrete target, constraints, and expected output.
...
| Type | Skill |
|------|-------|
| Mandatory | ck:google-adk-python |
