...
Source: `reference/marketing-stable/claude/skills/web-design-guidelines/SKILL.md`

## Authoritative Flow

1. Invoke /ck:web-design-guidelines with a concrete target, constraints, and expected output.
...
| Type | Skill |
|------|-------|
| Mandatory | ck:web-design-guidelines |
