...
Source: `reference/stable/claude/skills/mintlify/SKILL.md`

## Authoritative Flow

1. Invoke /ck:mintlify with a concrete target, constraints, and expected output.
