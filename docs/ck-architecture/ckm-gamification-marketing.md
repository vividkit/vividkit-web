...
Source: `reference/marketing-stable/claude/skills/gamification-marketing/SKILL.md`

## Authoritative Flow

1. Invoke /ckm:gamification-marketing with a concrete target, constraints, and expected output.
...
| Type | Skill |
|------|-------|
| Mandatory | ckm:gamification-marketing |
