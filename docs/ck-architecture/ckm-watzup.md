...
Source: `reference/marketing-stable/claude/commands/ckm/watzup.md`

## Authoritative Flow

1. Invoke /ckm:watzup with a concrete target, constraints, and expected output.
