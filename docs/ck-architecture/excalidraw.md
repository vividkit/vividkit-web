...
Source: `reference/stable/claude/skills/excalidraw/SKILL.md`

## Authoritative Flow

1. Invoke /excalidraw with a concrete target, constraints, and expected output.
