...
Source: `reference/marketing-stable/claude/commands/ckm/use-mcp.md`

## Authoritative Flow

1. Invoke /ckm:use-mcp with a concrete target, constraints, and expected output.
